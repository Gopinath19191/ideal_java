            ...
            <%int count = 0;%>
                                                           ...
                                                           <table id="apprMaster" align="center" cellpadding="2">
                                                            <tr align="center">
                                                                <td>
                                                                    Final Reviewer: </td>
                                                                <td>
                                                                    <select name="mynormalizerId" onchange="changeAppraiserAndReviewer()">
                                                                ...
                                                                <td>
                                                                  <select name="appraiseeSBUDepartmentId" onchange="changeAppraiserAndReviewer()">
                                                                       <option value="">--All-</option>
                                                                 ...
                                                                 <td>
                                                                    <select name="appraisalQuarter" id="appraisalQuarter" class="required" style="width: 4em"  onchange="changeAppraiserAndReviewer()" >
                                                                        ...
                                                                        <c:forEach begin="1" end="4" var="qValue">
                                                                            <c:choose>
                                                                                <c:when test="${appraisalQuarterHr == qValue}">
                ...
                <c:if test="${fn:length(appraiseesdetailsHr)>0}">
                    <div class="formarea">
                         ...
                         <tr class="${rowClass}">
                                            <td><a href="javascript:void(0)" onclick="sendAppraiseeInfo(${tes.appraiseeId},${tes.bandId},${appraisalQuarterHr},${appraisalYearHr},'${tes.appraiserName}',${tes.appraiseeEmpId},${tes.departmentId})">${tes.appraiseeEmpId}</a></td>
                                          ...
                                          <table width="100%">
                                            <tr>
                                                <td style="text-align: center">
                                                    <input class="buttons" type="button" onclick="showHideChart(this)" id="showChart" value="Show Chart" style="display:none"/>
                                                    <div id="chartContainer" >
                                                        <h3 style="padding:0px; margin: 0px;color: #3E576F;font-family:Arial;font-size: 12px">
                                                            <center>
                                                                <input type="button" class="buttons" onclick="showHideChart(this)" id="hideChart" value="Hide Chart"/>
                                                                <br>
                              ...
                              <tr>
                                  ...
                                  <input type="submit" style="width: 160px;" name="button" class="buttons submitbutton" id="SubmitToNormalizer" value="Submit To Finance" />
                                  <input type="submit" style="width: 190px;" name="button" id="saveRatingSB" class="buttons submitbutton" value="Send back for correction" onclick="return popupHr();"/>
