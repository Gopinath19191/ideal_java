...
//     }
        ...
        fromAddress   = Config.getChildElement(Config.getParentId("mail_details"),"common_username");
        mailPassword  = Config.getChildElement(Config.getParentId("mail_details"),"common_password");
        mailHost      = Config.getChildElement(Config.getParentId("mail_details"),"host");
        mailPort      = Config.getChildElement(Config.getParentId("mail_details"),"port");
...
//        mailPassword="Passw0rd@123";
    ...
    public boolean smtpMail(final String mailTo, final String mailSubject, final String mailMessage, final String mailCC)
			throws Exception {
                System.out.println(mailTo+mailSubject+mailMessage+mailCC+" forwarded details from appraiseeDAOImpl");
