...
<body onload="changeTabClass('aaFinalReviewer');" style="width: auto;">
                    ...
                    <div class="formarea">
                        <table width="100%">
                            ...
                            <c:forEach items="${appraiseesdetails}" var="tes" varStatus="status">
                                ...
                                <tbody>
                                    <tr class="${rowDisplay}">
                                        <td><a style="color: #4C83B3;font-size: 12px;font-weight: bold" href="javascript:void(0)" onclick="setAppraiseeDataNor(${tes.appraiseeId},${tes.bandId},${appraisalQuarter},${appraisalYear},'${tes.appraiserName}',${tes.appraiseeEmpId},${tes.departmentId},'finalReviewer')">${tes.appraiseeEmpId}</a>
                                        ...
                                        <c:if test="${tes.sendbackbyhr==0}">
                                            <td colspan="2" width="6%"><span class="displayText">
                                                    ...
                                                    <select style="width: 63px;text-align: center;" name="normalizerPromotionRecommended[]" class="required selectbox" onchange="removeErrorDiv(this.id,'Select Promotions');" id="${tes.appraiseeEmpId}" ${finalDisabled}>
                                            ...
                                            <td>
                                           <a style="color: #4C83B3;font-size: 12px;font-weight: bold"  class="qpdRating" href="${pageContext.request.contextPath}/com/defiance/ideal/qpd/managers/getQpdRating.do?appraiseeId=${tes.appraiseeId}" rel="${pageContext.request.contextPath}/com/defiance/ideal/qpd/managers/lastThreeQpdRatings.jsp">Previous QPD</a>
                                            </td>
                                            <td>
                                                <select style="width: 47px;text-align: center;" name="reviewerRatingForm[]" class="normalizerRatings selectbox" onchange="calculateRatings();removeErrorDiv(this.id,'Select Ratings');" id="${tes.appraiseeEmpId}" ${finalDisabled}>
                                                    <option value="">-- Select Rating --</option>
                                                    <c:forEach begin="1" end="5" var="rateValue">
                                                        <c:choose>
                                                            <%--<c:when test="${tes.reviewerRating == rateValue && tes.normalisedReviewerRating<1}">--%>
                                                            <c:when test="${tes.reviewerRating == rateValue && (tes.normalisedReviewerRating==null || tes.normalisedReviewerRating=='' || tes.normalisedReviewerRating==0)}">
                                                            ...
                                                            <c:when test="${tes.normalisedReviewerRating == rateValue && (tes.normalisedReviewerRating!=null || tes.normalisedReviewerRating!='' || tes.normalisedReviewerRating!=0)}">
                                        ...
                                        <c:if test="${tes.sendbackbyhr==1}">
                                            ...
                                            <td>
                                                <select style="width: 47px;text-align: center;"  class="normalizerRatings selectbox" onchange="calculateRatings();removeErrorDiv(this.id,'Select Ratings');" id="${tes.appraiseeEmpId}" ${finalDisabled} ${ratingDisabled}>
                                                    <option value="">-- Select Rating --</option>
                                                    <c:forEach begin="1" end="5" var="rateValue">
                                                        <c:choose>
                                                            <c:when test="${tes.reviewerRating == rateValue && tes.normalisedReviewerRating<1}">
                                            ...
                                            <td colspan="2">
                                                <select style="width: 47px;text-align: center;" name="reviewerRatingForm[]" class="normalizerRatingsNew selectbox" onchange="calculateRatings();removeErrorDiv(this.id,'Select Ratings');" id="${tes.appraiseeEmpId}" ${CorrectedNormalizerRatingDisabled}>
                                                    <option value="">-- Select Rating --</option>
                                                    <c:forEach begin="1" end="5" var="rateValue">
                                                        <c:choose>
                                                            <c:when test="${tes.normalisedReviewerRating == rateValue && tes.correctedNormalizerRating<1}">
