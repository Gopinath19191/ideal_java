    ...
    <c:if test="${fn:length(contractEmployeeObj)!=0}">
            ...
            <json:object>
                ...
                <json:property name="value" value="${contractEmployeeData.employeeName}-${contractEmployeeData.employeeNumber}"/>
                        ...
                        $("#rmName").autoSuggest('${pageContext.request.contextPath}/getEmployeeName.htm', {selectedItemProp: "value", asHtmlID:"rmName", searchObjProps: "value", selectionLimit:1, selectedValuesProp:"id"<c:if test="${fn:length(reportingManagerObj)!=0}">, preFill:reportingManagerData</c:if>});
                        $('#as-values-rmName').attr("class", "required");

                $("#empref").autoSuggest('${pageContext.request.contextPath}/getEmployeeName.htm', {selectedItemProp: "value", asHtmlID:"empref", searchObjProps: "value", selectionLimit:1, selectedValuesProp:"id"<c:if test="${fn:length(emprefObj)!=0}">, preFill:emprefdata</c:if>});
                        $('#as-values-empref');

                $("#empContract").autoSuggest('${pageContext.request.contextPath}/getEmployeeNamebyContract.htm', {selectedItemProp: "value", asHtmlID:"empContract", searchObjProps: "value", selectionLimit:1, selectedValuesProp:"id"<c:if test="${fn:length(contractEmployeeObj)!=0}">, preFill:contractempdata</c:if>});
    <c:if test="${fn:length(mailCcList)!=0}">
            ...
            <json:object>
                ...
                <json:property name="value" value="${mailCcValues.employeeName}-${mailCcValues.employeeNumber}"/>
                        ...
                        $("#mailCc").autoSuggest('${pageContext.request.contextPath}/getEmployeeNamebyhr1.htm', {selectedItemProp: "value", asHtmlID:"mailCc", searchObjProps: "value", selectionLimit:2, selectedValuesProp:"id"<c:if test="${fn:length(mailCcList)!=0}">, preFill:mailCcData</c:if>});
...
//                                alert(returnData[counter][outputOptText]);
            ...
            function checkEmail(selectedValue) {
                if (selectedValue != "") {
                    $.ajax({
                        url: '${pageContext.request.contextPath}/checkExistingEmail.htm',
                        type: "POST",
                        async: false,
            ...
            function backToList() {
                window.location.href = "${pageContext.request.contextPath}/begin.htm";
            }
            function backToApplicantList() {
                window.location.href = "${pageContext.request.contextPath}/applicantsList.htm";
            }
...
<body class="ext-gecko ext-gecko3" onload="<c:out value="${onloadFn}" />">
    ...
    <div id="container">
        ...
        <div id="commonforms">
            ...
            <div align="center">
                <form name="employeeAddForm" id="employeeAddForm" action="addOrUpdateEmployee.htm" method="post" onsubmit="return mailValidation();">
                    <c:choose>
                        <c:when test="${canStatus>=1} || ${candidateDetails.status == 'O'} ">
                    ...
                    <table width="99%" border="0" align="center" cellspacing="5" >
                        ...
                        <tr>
                            <td>
                                ...
                                <select name="structureName" id="companyStruct" class="required" onchange="changeStructureDesc(this.value, './getCompanyStructure.htm', 'sbu', '--Select--', 'structureId', 'structureName', this.id)" ${disableStatus} >
                            ...
                            <td>
                                <label for="sbu" class="" class="required">Business Unit<font color="red" size="4px;">*</font></label>
                                <select name="practiceGroup" id="sbu" class="required" onchange="changeStructureDesc(this.value, './getCompanyStructure.htm', 'subSbu', '--Select--', 'structureId', 'structureName', this.id);
                                         loadRRF(this.value);
                                        " ${disableStatus}>
                                    <option value="">--Select--</option>
                                    <c:forEach items="${practiceGroupList}" var="sbu">
                                        <c:choose>
                                            <c:when test="${sbu.practiceGroupId == candidateDetails.practiceGroupIdd}">
                            ...
                            <td>
                                <label for="subSbu" class="" class="required">Practice Name<font color="red" size="4px;">*</font></label>
                                <select name="subPracticeGroup" id="subSbu" class="required" onchange="changeStructureDesc(this.value, './getCompanyStructure.htm', 'subpractice2', '--Select--', 'structureId', 'structureName', this.id)" ${disableStatus} >
                                    <option value="">--Select--</option>
                                    <c:forEach items="${subPracticeGroupList}" var="subSbu">
                                        <c:choose>
                                            <c:when test="${subSbu.subPracticeGroupId == candidateDetails.subPracticeGroupId}">
                                                <c:out value="${subSbu.subPracticeGroup}"></c:out>
                        ...
                        <tr>
                            <td>
                                ...
                                <select name="band" id="band" class="required" onchange="changeStructureDesc(this.value, './getSubDetails.htm', 'subBand', '--Select--', 'bandId', 'bandName', this.id)" ${disableStatus} >
                                    <option value="">--Select--</option>
                        ...
                        <tr>
                            <td>
                                <label for="rmName" class="" >Name of Reporting Manager<font color="red" size="4px;">*</font></label>
                                    <c:if test="${(canStatus==0 || canStatus==null) && candidateDetails.status ==null}">
                                    <input type="text" name="reportingManager" value ="${candidateDetails.reportingManager}" id="rmName" ${disableStatus} />
                                </c:if>
                                <c:if test="${canStatus>=1 || candidateDetails.status == 'O'}">
                                    <b>  ${reportingManagerName} </b>
                                </c:if>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span id = "email_err" style="color: red;display: none">Please Enter Different Email Id</span>
                            </td>

                            <td>
                                <label for="passportNumber" class="">Passport number</label>
                        ...
                        <tr>
                            <td>
                                ...
                                <span class="customError" id="passportRequired" style="display:none">Enter Pan Number</span>
                            </td>
                            <td>
                                ...
                                <select name="sourceofhire" id="sourceofhire" class="required" onchange="fndispage()" ${disableStatus}>
                                    ...
                                    <c:forEach items="${sourceofhirelist}" var="sourceofhirelist" >
                                        <option <c:if test="${candidateDetails.sourceofhire==sourceofhirelist.sourceconfval}">selected="true"</c:if> value="${sourceofhirelist.sorceconfkey}"> ${sourceofhirelist.sourceconfval}</option>
                                    </c:forEach>
                                </select>
                            </td>
                            ...
                            <c:if test="${buttonStatus=='triggerMail' || canStatus>=1 || buttonStatus=='editMode'}">
                                ...
                                <c:if test="${buttonStatus=='triggerMail' || canStatus>=1}">
                                    <td><label for="mailTo" class="">Mail To<font color="red" size="4px;">*</font></label>
                                        <input type="text" name="mailTo" id="mailTo" value="${candidateDetails.personalEmailId1}${(candidateDetails.personalEmailId2 != '')?',':''}${candidateDetails.personalEmailId2}" ${disableStatus} title="${candidateDetails.personalEmailId1},${candidateDetails.personalEmailId2}"/></td>
                        ...
                        <tr>
                            <c:if test="${candidateDetails.jfId == null}">
                            <td valign="top">
                                <label class="">RRF Id<font color="red" size="4px;">*</font></label>
                                <input type="hidden" id="selectedRRF" value="${candidateDetails.rrf_id}" />
                            ...
                            <c:if test="${candidateDetails.jfId != null }">
                                <input type="hidden" name = "rrf_id" id="selectedRRF" value="${candidateDetails.rrfRes}" />
                                    <td>
                                        <label class="">RRF Id<font color="red" size="4px;">*</font></label>
                                        ${rrfName}
                                    </td>
                                </c:if>
                               <!--  <c:if test="${candidateDetails.status == 'O'}">
                                <input type="hidden" name = "rrf_id" id="selectedRRF" value="${candidateDetails.rrf_id}" />
                                    <td>
                                        <label class="">RRF Id<font color="red" size="4px;">*</font></label>
                                        <b> ${candidateDetails.rrf_id} </b>
                                    </td> 
                                </c:if>   -->
                            <td valign="top">
                                <label class="">Employee Type<font color="red" size="4px;">*</font></label>
                                <c:choose>
                                <c:when test="${candidateDetails.jfId == null || candidateDetails.jfId == ''}">
                                <select name="contract_type" id="contract_type" class="required" onchange="existingEmployee()" ${disableStatus}>
                                    ...
                                    <c:otherwise>
                                    <select name="contract_type" id="contract_type" class="required" onchange="existingEmployee()" disabled="disabled">
                                    <option value="n" ${candidateDetails.employeeCategory=='n'?'selected':''} >New</option>
                                    <option value="e" ${candidateDetails.employeeCategory=='e'?'selected':''} >DC / VC</option>
                                </select>
                                    </c:otherwise>
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <label class="">DC / VC<font color="red" size="4px;">*</font></label>
                                                ...
                                                <c:if test="${candidateDetails.jfId != null}">
                                                <input type="hidden" id="emp_contract" name = "emp_contract" value="${candidateDetails.contract_employee_id}" />
                                                <label class="">DC / VC<font color="red" size="4px;">*</font></label>
                                                ${contractEmployeeName}
                                                </c:if>
                                </div>
                        ...
                        <c:if test="${buttonStatus=='editMode' || buttonStatus==null}">
                            ...
                            <tr>
                                <td colspan="3" align="center">
                                    <input type="submit" class="submitbutton" name="buttonName" value="${submitButton}" onclick="return validatation();" ${disableStatus}>
                                    <input type="button" class="cancelbutton" value="${cancelButton}" onclick="backToApplicantList();" >
                                </td>
                            </tr>
                        </c:if>
                        <tr>
                            <td colspan="3">
                                ...
                                <input type="hidden" name="trackNumber" value ="${candidateDetails.trackNumber}" id="trackNumber"/>
                                 ...
                                 <c:if test="${candidateDetails.status != null}">
                                <input type="hidden" name="status" value ="${candidateDetails.status}" id="status"/>
                                <input type="hidden" name="appId" value ="${candidateDetails.appId}" id="appId"/>
                                <input type="hidden" name="reportingManager" value ="${candidateDetails.reportingManager}" id="reportingManager"/>
