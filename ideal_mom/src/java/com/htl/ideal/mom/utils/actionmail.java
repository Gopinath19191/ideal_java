...
public class actionmail {
    ...
    public actionmail(String username,String password,String host,String port) throws FileNotFoundException, IOException{
    ...
    public boolean smtpMail(final String mailTo, final String mailSubject, final String mailMessage)
			throws Exception {
