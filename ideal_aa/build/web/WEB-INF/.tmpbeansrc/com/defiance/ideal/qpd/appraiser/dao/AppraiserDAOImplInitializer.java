...
public class AppraiserDAOImplInitializer
extends org.apache.beehive.controls.runtime.bean.ImplInitializer
{
    ...
    */
    ...
    {
        com.defiance.ideal.qpd.appraiser.dao.AppraiserDAOImpl __bc_impl = (com.defiance.ideal.qpd.appraiser.dao.AppraiserDAOImpl)target;
        // DO NOT DELEGATE TO SUPERCLASS HERE.  THE CONTROL CLIENT INIT HIERARCHY
        // WILL INITIALIZE ALL THE WAY DOWN TO THE BASE CLASS!
        
        try
        {
            com.defiance.ideal.qpd.appraiser.dao.AppraiserDAOImplClientInitializer.initialize(bean.getControlBeanContext(), __bc_impl);
        }
