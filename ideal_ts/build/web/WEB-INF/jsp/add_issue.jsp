<%-- 
    Document   : add_issue
    Created on : 25 Feb, 2016, 10:20:46 AM
    Author     : 16113
--%>
    ...
    <script type="text/javascript">
        ...
        function insertIssue(){
            ...
            if(subject==null || subject==""){
                ...
                $('#addFeedbackPage').attr("action", "insertIssue.htm");
                ...
                <form name="addFeedbackPage" method="post" id="addFeedbackPage">
                  ...
                  <table align="center" style="width: 100%" >
                      <tr> <td class="labelling"><b>Issue Name</b></td>
                                <td class="labelling"> <input type="text" value="" name="issueName" id="issueName"></td>
                                <td class="labelling"><div id="addStatus"><table id="statusTable">
                                            <tr>
                                                <td align="center"><b>Status</b></td>
                                                <td> <a class="add" style="text-decoration:none;color: #4C83B3;margin-right: 2px;" href="javascript:nextStatus('statusTable')"></a></td>
                                            </tr>
                                            <tr><td><input type="text" value="" name="status"></td><td> 
                                        </table></div> <td class="labelling">
                      </tr>       
                <tr> <td class="labelling"> <td class="labelling"></tr> 
                <tr>
                   <td class="labelling"> </td>
                              <td class="labelling">
                    <input type="button" value="Submit" class="submitbutton_TS" onclick="insertIssue();"/>&nbsp;&nbsp;&nbsp;
