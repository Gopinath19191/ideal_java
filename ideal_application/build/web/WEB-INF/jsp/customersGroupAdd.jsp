            ...
            if($("#formCustomerDetails").valid()) {
                ...
                if($("#groupName").val() != "") {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        async: false,
                        data: ({customerGroupName:customerGroupNameD}),
    ...
    <div id="container">
        <div id="">
            <div class="container_inner" style="margin: 30px 0 24px;">
                <p class="page_heading"><span class="heading">Add Customer Group</span> </p>
            </div>
            ...
            <form action="saveCustomerGroup.htm" name="formCustomerDetails" id="formCustomerDetails" method="post">
                        ...
                        <tbody>
                            ...
                            <tr class="">
                                <td  style="text-align:left">
                                    <label class="">Group Name<font color="red">*</font></label>
                                </td>
                                <td style="text-align:left">
                                    <input type="text" name="groupName" style="width: 305px;" id="groupName" class="required textbox_new" value="">
                                </td>
                                <td  style="text-align:left">
                                    <!--                                    <label class="headLabel">Group Code</label>-->
                                </td>
                                <td style="text-align:left">
                                    <!--                                    <input type="text" name="groupCode" id="groupCode" class="required formInputField" value="">-->
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="buttonAlignment">
                    <div class="buttonAlignment" id="btnGroup">
                        ...
                        <input type="submit" name="customerGroupSubmitButton" id="submitBtn" value="Submit" style="width: 90px;" class="qualitysubmit" onclick="return disableSubmit('saveBtn','submitBtn','btnCancel');">
