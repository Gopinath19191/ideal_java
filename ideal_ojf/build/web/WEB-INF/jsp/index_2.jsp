<%@include file="header.jsp" %>
  ...
  <body>
      ...
      <span class="topheading">QJF (Online Joining Formalities)</span>
      <div class="loginContent">
          ...
          <div class="loginInfo">
                <form name="login" method="POST" action="${pageContext.request.contextPath}/validate.html" id="validateForm">
                    ...
                    <c:if test="${param.empid == null}">
                        <td><input class="required qpd_usernamefield" name="userName" id="userName" type="text" maxlength="255" value="" /></td>
                    </c:if>
                    <c:if test="${param.empid != null}">
                        <td>
