<%-- 
    Document   : ndaFormB
    Created on : 20 Aug, 2019, 12:49:15 PM
    Author     : 16221
--%>
...
<body onload="">
        <div id="container">
            ...
            <div class="goToList" style="width: 300px;">
                <a class="listReport" href="getReport.htm?type=NDA" target="_self" style="text-decoration:none;cursor: pointer;" title="View Report">NDA Report</a>
                <a class="listReport" href="getReport.htm?type=Form B" target="_self" style="text-decoration:none;cursor: pointer;" title="View Report">Form B Report</a>
            </div>
                    ...
                    <table id="customerDataList"  class="display">
                        ...
                        <c:forEach items="${employee_list}" var="employeelist" varStatus="rpritr">
                            ...
                            <tr class="${rowClass}">
                                ...
                                <td>
                                    <a title="Edit" target="_self" style="text-decoration:none" href="${pageContext.request.contextPath}/getEmployeeDetailsForNda.htm?employee_id=${employeelist.employee_id}"><img src="${pageContext.request.contextPath}/css/images/edit-icon.png" style="padding-left: 8px;"></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </table>
