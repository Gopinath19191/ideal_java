...
public class AppraiseeControllerClientInitializer
extends org.apache.beehive.controls.runtime.bean.ClientInitializer
{
    ...
    static
    {
        try
        {
            _controlObjField = com.defiance.ideal.qpd.appraisee.AppraiseeController.class.getDeclaredField("controlObj");
            _controlObjField.setAccessible(true);
            _sharedControlObjField = com.defiance.ideal.qpd.appraisee.AppraiseeController.class.getDeclaredField("sharedControlObj");
    ...
    com.defiance.ideal.qpd.appraisee.AppraiseeController client)
    {
        try
        {
            String __bc_id;
            ...
            //
            __bc_id = client.getClass() + "@" + client.hashCode() + ".com.defiance.ideal.qpd.appraisee.bo.AppraiseeBO.controlObj";
            com.defiance.ideal.qpd.appraisee.bo.AppraiseeBOBean _controlObj = (cbc == null ? null : (com.defiance.ideal.qpd.appraisee.bo.AppraiseeBOBean)cbc.getBean(__bc_id));
            if (_controlObj == null)
            _controlObj = (com.defiance.ideal.qpd.appraisee.bo.AppraiseeBOBean) Controls.instantiate(com.defiance.ideal.qpd.appraisee.bo.AppraiseeBOBean.class, getAnnotationMap(cbc, _controlObjField), cbc, __bc_id );
    ...
    public static void initialize(ControlBeanContext cbc, com.defiance.ideal.qpd.appraisee.AppraiseeController client)
    {
