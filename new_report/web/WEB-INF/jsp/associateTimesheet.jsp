        ...
        <form name="reportForm" id="reportForm" method="POST">
            <div class="tabletools">
                <table>
                    <tr>
                        <td>
                            <label class="label_name" for="monthFilter" ><b>Month :</b> </label>
                        ...
                        <td>
                            <label class="label_name" for="yearFilter" ><b>Year :</b> </label>
                        ...
                        <td>
                            <label class="label_name" for="sbuFilter" ><b>SBU :</b> </label>
                        ...
                        <td> 
                            <input class="gobutton" onclick="submitForm()" type="button"  value="Go"/>
                            <input type="button" value="Export" onclick="exportToExcel()" class="exportbutton" />
                        </td>
                    </tr>
                    <tr>
        ...
        <div id="datadisplay" style="overflow-x:scroll ">
            <table>
                ...
                <tbody>
                    <c:if test="${fn:length(filterData)!=0}">
                        <c:forEach items="${filterData}" var="filterData" varStatus="rpritr">
                            <tr>
                                ...
                                <td>
                                    ${filterData.joinedDate} 
                                </td>
                                <td>
                                    <c:choose>
                                        <c:when test="${filterData.releasedDate != null}">
                                            ${filterData.releasedDate}
                                        </c:when> 
                                        <c:otherwise>
                                            ----
                                        </c:otherwise>
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${filterData.availableHrs != null}">
                                            ${filterData.availableHrs} 
                                        </c:when>
                                        <c:otherwise>
                                            0.00
                                        </c:otherwise>
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${filterData.accrued_hours != null}">
                                            ${filterData.accrued_hours} 
                                        </c:when>
                                        <c:otherwise>
                                            0.00
                                        </c:otherwise>
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${filterData.working_days != null}">
                                            ${filterData.working_days} 
                                        </c:when>
                                        <c:otherwise>
                                            0.00
                                        </c:otherwise>
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${filterData.noofLeaveTakenDays != null}">
                                            ${filterData.noofLeaveTakenDays} 
                                        </c:when>
                                        <c:otherwise>
                                            0.00
                                        </c:otherwise>
                    ...
                    <c:if test="${fn:length(filterData)==0}">
                        <tr class="row-odd">
                            <td colspan="43" style="text-align: center;">
                                No data to display
                            </td>
                        </tr>
                    </c:if>
