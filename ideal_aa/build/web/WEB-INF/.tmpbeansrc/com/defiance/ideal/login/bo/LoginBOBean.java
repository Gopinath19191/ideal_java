...
public class LoginBOBean
extends org.apache.beehive.controls.runtime.bean.ControlBean
implements com.defiance.ideal.login.bo.LoginBO
{
    ...
    */
    public LoginBOBean(ControlBeanContext context, String id, PropertyMap props)
    {
        this(context, id, props, com.defiance.ideal.login.bo.LoginBO.class);
    }
    ...
    */
    protected LoginBOBean(ControlBeanContext context, String id, PropertyMap props, Class controlClass)
    {
    ...
    */
    ...
    /**
    * Implements com.defiance.ideal.login.bo.LoginBO.menuCheck
    */
    public  com.defiance.ideal.login.dto.LoginFormDTO menuCheck(java.lang.String referenceName, int currentYear, int employeeId) 
    {
        ...
        com.defiance.ideal.login.bo.LoginBO __bc_target = (com.defiance.ideal.login.bo.LoginBO)ensureControl();
    ...
    /**
    * Implements com.defiance.ideal.login.bo.LoginBO.authenticateLoginDetails
    */
    public  com.defiance.ideal.login.dto.LoginFormDTO authenticateLoginDetails(javax.servlet.http.HttpServletRequest request) 
    {
    ...
    /**
    * Implements com.defiance.ideal.login.bo.LoginBO.updateManagerSurvey
    */
    ...
    /**
    * Implements com.defiance.ideal.login.bo.LoginBO.authenticateUser
    */
    public  com.defiance.ideal.login.dto.LoginFormDTO authenticateUser(java.lang.String userAccountId, java.lang.String MODULE_ID) 
    {
        Object [] __bc_argArray = new Object[] { userAccountId, MODULE_ID };
        Throwable __bc_thrown = null;
        com.defiance.ideal.login.bo.LoginBO __bc_target = (com.defiance.ideal.login.bo.LoginBO)ensureControl();
        com.defiance.ideal.login.dto.LoginFormDTO __bc_retval = null;
        ...
        try
        {
            ...
            __bc_retval =
            __bc_target.authenticateUser(userAccountId, MODULE_ID)
            ;
        }
        catch (Throwable __bc_t)
        {
    ...
    /**
    * Implements com.defiance.ideal.login.bo.LoginBO.authenticateGroup
    */
    ...
    /**
    * Implements com.defiance.ideal.login.bo.LoginBO.managerSurvey
    */
