                    ...
                    <table id="formTable" border="0" align="center">
                        <tbody>
                            ...
                            <!--<tr class="odd">
                                    ...
                                    <td width="25%" style="text-align:left">
                                        <input type="radio" name="customerGroup" id="customerGroupY" class="required formInputField" value="y" onclick="hideCustomerGroupName();"><label style="float:left;width: 25px;">Yes</label>
                                        <input type="radio" name="customerGroup" id="customerGroupN" class="required formInputField" value="n" onclick="hideCustomerGroupName();"><label style="float:left">No</label>
                                    </td>
                                    <td width="25%" style="text-align:left">
                            ...
                            <%-- <c:forEach items="${customerGroup}" var="customerGroupName" >
                                <option value="${customerGroupName.customerID}">${customerGroupName.customerGroupName}</option>
                            </c:forEach> --%>
                            ...
                            <tr class="">
                                <td  style="text-align:left">
                                    <label class="">Customer Email<font color="red">*</font></label>
                                </td>
                                <td  style="text-align:left">
                            ...
                            <tr class="">
                                <td  style="text-align:left">
                                    <label class="">Customer Address<font color="red">*</font></label>
                                </td>
                                <td  style="text-align:left">
                                ...
                                <td  style="text-align:left">
                                    <label class="">About Customer<font color="red">*</font></label>
                                </td>
                                <td  style="text-align:left">
