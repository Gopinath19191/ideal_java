<%-- 
    ...
    Created on : 5 Dec, 2017, 9:52:10 AM
    Author     : 16221
--%>
    ...
    <body>
        <div class="container"> 
            <p class="page_heading">
                Purchase Request - 
                <c:if test="${status=='m'}">Pending List</c:if>
                <c:if test="${status=='a'}">Processed List</c:if>
            </p>
            <div class="goToList">
                <c:if test="${status=='m'}">
                    <img src="/ideal_attendance/images/icon_list.png" title="Apply Procurement" alt="Add Procurement">
                    <a style="text-decoration:none;color: #4C83B3;" target="_self" href="procurementRMProcessedList.htm?status=a">Processed List</a>
                </c:if>
                <c:if test="${status=='a'}">
                    <img src="/ideal_attendance/images/icon_list.png" title="Apply Procurement" alt="Add Procurement">
                    <a style="text-decoration:none;color: #4C83B3;" target="_self" href="procurementRMList.htm?status=m">Pending List</a>
                </c:if>
            </div>
