...
<!--                        <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/addDomesticTravel.htm">Add Travel</a></li>-->
                    </ol>
                    <h6 class="slim-pagetitle">Domestic Travel List</h6>
                </div>
                <div class="section-wrapper">
                    <!--<label class="section-title">Request List</label>-->
                    <div Style="float:right;margin-bottom: 10px;">
                        <a href="${pageContext.request.contextPath}/addDomesticTravel.htm">Add Travel</a>
                    </div>
                        ...
                        <table id="datatable1" class="table display table-responsive">
                            ...
                            <tbody>
                                <c:if test="${fn:length(list)>0}">
                                    <c:forEach items="${list}" var="travelDetails" varStatus="ticket_loop">
                                        <tr>
                                            <td class="wd" style="display:none;"><a style="display:none;">${travelDetails.master_id}</a></td>
                                            <td class="wd-10p" style="vertical-align: middle;"><a href="${pageContext.request.contextPath}/viewTravelDetails.htm?master_id=${travelDetails.master_id}">${travelDetails.tp_reference_id}</a></td>
                                            <td class="wd-10p" style="vertical-align: middle;">${travelDetails.requested_date}</td>
                                            <td class="wd-20p" style="vertical-align: middle;">${travelDetails.customer_name}</td>
                                            <td class="wd-20p" style="vertical-align: middle;">${travelDetails.project_name}</td>
                                            <td class="wd-15p" style="vertical-align: middle;">${travelDetails.status}</td>
                                            <td class="wd-10p" style="vertical-align: middle;">
                                                <a href="${pageContext.request.contextPath}/viewTravelDetails.htm?master_id=${travelDetails.master_id}" class="fa fa-eye"></a>
                                                <a href="${pageContext.request.contextPath}/editDomesticTravel.htm?master_id=${travelDetails.master_id}" class="icon ion-compose"></a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </c:if>
