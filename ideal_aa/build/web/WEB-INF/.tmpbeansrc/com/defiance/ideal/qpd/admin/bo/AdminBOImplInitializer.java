...
public class AdminBOImplInitializer
extends org.apache.beehive.controls.runtime.bean.ImplInitializer
{
    ...
    */
    ...
    {
        com.defiance.ideal.qpd.admin.bo.AdminBOImpl __bc_impl = (com.defiance.ideal.qpd.admin.bo.AdminBOImpl)target;
        // DO NOT DELEGATE TO SUPERCLASS HERE.  THE CONTROL CLIENT INIT HIERARCHY
        // WILL INITIALIZE ALL THE WAY DOWN TO THE BASE CLASS!
        
        try
        {
            com.defiance.ideal.qpd.admin.bo.AdminBOImplClientInitializer.initialize(bean.getControlBeanContext(), __bc_impl);
        }
