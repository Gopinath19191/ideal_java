...
public class ManagersControllerClientInitializer
extends org.apache.beehive.controls.runtime.bean.ClientInitializer
{
    ...
    static
    {
        try
        {
            _controlObjField = com.defiance.ideal.qpd.managers.ManagersController.class.getDeclaredField("controlObj");
            _controlObjField.setAccessible(true);
            _sharedControlObjField = com.defiance.ideal.qpd.managers.ManagersController.class.getDeclaredField("sharedControlObj");
    ...
    com.defiance.ideal.qpd.managers.ManagersController client)
    {
        try
        {
            String __bc_id;
            ...
            //
            __bc_id = client.getClass() + "@" + client.hashCode() + ".com.defiance.ideal.qpd.managers.bo.ManagerBO.controlObj";
            com.defiance.ideal.qpd.managers.bo.ManagerBOBean _controlObj = (cbc == null ? null : (com.defiance.ideal.qpd.managers.bo.ManagerBOBean)cbc.getBean(__bc_id));
            if (_controlObj == null)
            _controlObj = (com.defiance.ideal.qpd.managers.bo.ManagerBOBean) Controls.instantiate(com.defiance.ideal.qpd.managers.bo.ManagerBOBean.class, getAnnotationMap(cbc, _controlObjField), cbc, __bc_id );
    ...
    public static void initialize(ControlBeanContext cbc, com.defiance.ideal.qpd.managers.ManagersController client)
    {
