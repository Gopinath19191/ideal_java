                ...
                <table>
                    <tr>
                        <td width="33%">
                            ...
                            <select id="monthFilter" name="monthFilter" onchange="submitForm()" class="selectbox" style="width: 170px;">
                            ...
                            <select id="yearFilter" name="yearFilter" onchange="submitForm()" class="selectbox" style="width: 170px;">
                            ...
                            <label for="projectFilter" ><b>Project :</b> </label>

                            <select id="projectFilter" name="projectFilter" onchange="submitForm()" class="selectbox" style="width: 170px;">
                        ...
                        <td> <center> <input type="button" align="middle" style="float: none" value="Excel" onclick="exportToExcel()" class="exportbutton" /> </center> </td></tr>
                    <tr>
                        <td colspan="3">
