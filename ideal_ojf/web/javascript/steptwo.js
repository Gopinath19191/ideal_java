function addRow_Employer() {
    if (employer_validation(1)) {
        ...
        tr += '       <input name="exp_attachment_' + rowId + '" id="exp_attachment_' + rowId + '" size="8" type="file" style="width: 120px;">';
...
function addRow_Education() {
    if (education_validation(1)) {
        ...
        tr += '   </td>';
        tr += '   <td valign="top">';
        tr += '<span id="span1_institution_' + rowId + '"><select name="institution" id="institution_' + rowId + '" style="width:100%" onchange="loadTextBox(this.value,'+rowId+');">'
        ...
        tr += '<div id="other_institution_'+ rowId +'" class="other_institution" style="display:none">';
        tr += '<label>Institution Name</label><input type="text" class="" value="" id="other_institution_tb'+ rowId +'" name="otherInstitute" style="width:100%"/><span style="color:red;display:none;" id="other_institution_error_' + rowId + '" >*required</span></div>'; 
        tr += '<div id = "institution_err_' + rowId + '" style = "display: none;"><font style = "color:red;">Only Alphanumerics are allowed</font></div>';
        tr += '</td>';
        tr += '<td valign="top">';
        tr += '<span id="span1_university_' + rowId + '"><select name="university" id="university_' + rowId + '" style="width:100%" onchange="loadUniversityText(this.value,'+ rowId +');">'
        ...
        tr += '<div id="other_university_'+ rowId +'" class="other_university" style="display:none"><label>University Name</label><input type="text" class="" value="" id="other_university_tb' + rowId +'" name="otheruniversity" style="width:100%"/><span style="color:red;display:none;" id="other_university_error_' + rowId + '">*required</span></div>';
            ...
            if ($('#degree_' + i).val() != '' && $('#year_of_passing_' + i).val() != '' && $('#percentage_' + i).val() != '') {
                ...
                if ($('#degree_' + i).val() == 10 || $('#degree_' + i).val() == 12) {
                    ...
                    if ($('#university_' + i).val() == '') {
                        ...
                        $('#university_error_' + i).hide();
                    if ($('#institution_' + i).val() == '1205'){
                    if($('#other_institution_tb' +i).val()== ''){
                        
                        $('#other_institution_error_' +i).show();
                        
                        
                        flagCount++;
                       
             }       else{
                        $('#other_institution_error_' +i).hide();
}}
                if ($('#university_' + i).val() == '605') {
                if($('#other_university_tb' +i).val()== ''){
                         
 
                        $('#other_university_error_' +i).show();
                        ...
                        $('#other_university_error_' +i).hide();
}    
                }}
...
function change(val, row_id) {
    if (val == 10 || val == 12) {
        ...
        $('#other_institution_' +row_id).hide();
        $('#span1_university_' + row_id).hide();
        $('#span2_university_' + row_id).show();
        $('#other_university_'+row_id).hide();
