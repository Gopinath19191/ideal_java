...
public class LoginDAOBeanBeanInfo
extends org.apache.beehive.controls.runtime.bean.ControlBeanInfo
{
    ...
    */
    public LoginDAOBeanBeanInfo()
    {
        super(com.defiance.ideal.login.dao.LoginDAOBean.class);
    }
    
    /**
    * Protected constructor used if this BeanInfo class is extended.
    */
    protected LoginDAOBeanBeanInfo(Class beanClass)
    {
        super(beanClass);
    }
    ...
    {
        BeanDescriptor bd = new BeanDescriptor(com.defiance.ideal.login.dao.LoginDAOBean.class);
        bd.setName( "LoginDAOBean" );
        bd.setDisplayName( "LoginDAOBean" );
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        //
        // Declare MethodDescriptor for authenticateUser(empId, MODULE_ID)
        //
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        pd = new PropertyDescriptor( "controlImplementation" , com.defiance.ideal.login.dao.LoginDAOBean.class, "getControlImplementation", "setControlImplementation");
