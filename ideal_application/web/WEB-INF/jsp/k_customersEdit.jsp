    ...
    <div id="container">
        <div id="">
            <div class="container_inner" style="margin: 30px 0 24px;">
                <p class="page_heading"><span class="heading">Edit Client</span> </p>
            </div>
                ...
                <div class="formContent_new" id="datadisplay" style="height:auto">
                    <table id="formTable" border="0" align="center">
                        <tbody>
                            ...
                            <input type="radio" name="customerGroup" ${selectedYesValue} id="customerGroupY" class="required formInputField" value="y" onclick="hideCustomerGroupName();"><label style="float:left;width: 25px;">Yes</label>
                            <input type="radio" name="customerGroup" ${selectedNoValue} id="customerGroupN" class="required formInputField" value="n" onclick="hideCustomerGroupName();"><label style="float:left">No</label>
                        </td>
                        <td width="25%" style="text-align:left">
                            <label class="headLabel">Customer Group</label>
                        </td>
                        <td width="25%" style="text-align:left">
                            <select name="customerGroupName" id="customerGroupName" class="formInputField">
                            ...
                            <tr class="">
                                <td  style="text-align:left">
                                    <label class="">Client Name<font color="red">*</font></label>
                                </td>
                                <td  style="text-align:left">
                                    <input type="text" name="customerName" id="customerName" class="required textbox_new" value="${selectedCustomerData[0].customerName}">
                                </td>
                                <td  style="text-align:left">
...
<!--                                <td style="text-align:left">
                                ...
                                <td  style="text-align:left">
                                    <select name="businessLeaderName" id="businessLeaderName" class="textbox_new">
                                        ...
                                        <c:forEach items="${businessLeader}" var="businessLeader" >
                                            ...
                                            <option value="${businessLeader.salesManId}" ${selbusinessLeaderName}>${businessLeader.employeeName} - ${businessLeader.employeeNumber}</option>
                                        </c:forEach>
                                ...
                                <td  style="text-align:left">
                                    <input type="text" name="customerContactPerson" id="customerContactPerson" class="textbox_new" value="${selectedCustomerData[0].customerContactPerson}">
                                </td>
                                <td  style="text-align:left">
                                    <label class="">Contact Person No</label>
                                </td>
                                <td  style="text-align:left">
                                    <input type="text" name="salesPersonContactNo" id="salesPersonContactNo" class="textbox_new" value="${selectedCustomerData[0].salesPersonContactNo}">
                                </td>
                            </tr>
                            <tr class="">
                                <td  style="text-align:left">
                                ...
                                <td  style="text-align:left">
                                    <input type="text" name="customerEmail" id="customerEmail" class="email textbox_new" value="${selectedCustomerData[0].customerEmail}">
                                </td>
                                <td style="text-align:left">
                                    <label class="">Client Contact Phone</label>
                                </td>
                                <td style="text-align:left">
                                    <input type="text" name="customerContactPhone" id="customerContactPhone" class="textbox_new" value="${selectedCustomerData[0].customerContactPhone}">
                                </td>
                            </tr>
<!--                            <tr class="">
...
<!--                                <td  style="text-align:left">
                                ...
                                <td  style="text-align:left">
                                    <input type="text" name="customerURL" id="customerURL" class="url textbox_new" value="${selectedCustomerData[0].customerURL}">
                                </td>
                                 <td style="text-align:left">
                                    <label class="">Tax Registration No</label>
                                </td>
                                <td style="text-align:left">
                                    <input type="text" name="stcNo" id="stcNo" class="textbox_new" value="${selectedCustomerData[0].stcNo}">
                                </td>
                            </tr>
<!--                            <tr class="">
                                <td  style="text-align:left">
...
<!--                            <tr class="">
                            ...
                            <tr class="">
                                <td  style="text-align:left">
                                    <label class="">SBU<font color="red">*</font></label>
                                </td>
                                <td  style="text-align:left">
                                    <select name="SBU" id="SBU" class="required textbox_new">
                            ...
                            <tr class="">
                                ...
                                <td  style="text-align:left">
                                    <textarea cols="20" rows="2" style="height: 55px;width: 158px;" name="customerAddress" id="customerAddress"  maxlength="500"  minlength="10" onblur="textLimit(this,500);" onkeyup="textLimit(this,200)" class="textbox_new required minlength maxlength resizableTextArea ui-resizable">${selectedCustomerData[0].customerAddress}</textarea>
                                </td>
                                <td  style="text-align:left">
                                    <label class="">About Client<font color="red">*</font></label>
                                </td>
                                <td  style="text-align:left">
                                    <textarea cols="20" rows="2" style="height: 55px;width: 158px;" name="aboutCustomer" id="aboutCustomer"  maxlength="500"  minlength="10" onblur="textLimit(this,500);" onkeyup="textLimit(this,1000)" class="textbox_new required minlength maxlength resizableTextArea ui-resizable">${selectedCustomerData[0].aboutCustomer}</textarea>
                                </td>
                            </tr>
                            <c:if test="${selectedCustomerData[0].status != 's'}">
                                <tr class="">
                                    <td  style="text-align:left">
                                        <label class="">Client Group</label>
                                    </td>
                                    <td  style="text-align:left">
                                        <select disabled name="customerGroupName" id="customerGroupName" class="textbox_new">
                                    ...
                                    <td  style="text-align:left">
                                        <input disabled type="text" name="termsOfPayment" id="termsOfPayment" class="textbox_new" value="${selectedCustomerData[0].termsOfPayment}"> Days
                                    </td>
                                </tr>
                            </c:if>
                        </tbody>
