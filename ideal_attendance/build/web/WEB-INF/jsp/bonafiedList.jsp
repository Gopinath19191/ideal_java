<%-- 
    Document   : bonafiedList
    Created on : 23 Aug, 2019, 4:06:16 PM
    Author     : 16221
--%>
...
<body onload="">
        <div id="container">
            <p class=" page_heading">Bonafide - Employee List</p>
            <div class="goToList" style="width: 300px;">
                <a class="listReport" href="getReport.htm?type=Bonafied" target="_self" style="text-decoration:none;cursor: pointer;" title="View Report">View Report</a>
            </div>
                    ...
                    <table id="customerDataList"  class="display">
                        ...
                        <c:forEach items="${employee_list}" var="employeelist" varStatus="rpritr">
                            ...
                            <tr class="${rowClass}">
                                ...
                                <td>
                                    <a title="Edit" target="_self" style="text-decoration:none" href="${pageContext.request.contextPath}/getEmployeeDetailsForBonafied.htm?employee_id=${employeelist.employee_id}"><img src="${pageContext.request.contextPath}/css/images/edit-icon.png" style="padding-left: 8px;"></a>
                                </td>
                                <td>
                                    <a title="Edit" target="_self" style="text-decoration:none" href="${pageContext.request.contextPath}/getEmployeeDetailsForDeputation.htm?employee_id=${employeelist.employee_id}"><img src="${pageContext.request.contextPath}/css/images/edit-icon.png" style="padding-left: 8px;"></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </table>
