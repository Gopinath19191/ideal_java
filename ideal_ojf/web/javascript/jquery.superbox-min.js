...
*
*/
//(function(i){var l,t,r,q,a,p,h,o,j,w,b={boxId:"superbox",boxClasses:"",overlayOpacity:0.8,boxWidth:"1200",boxHeight:"400",loadTxt:"Loading...",closeTxt:"Close",prevTxt:"Previous",nextTxt:"Next",beforeShow:function(){}},x={},m=false,s=i([]);
(function(i){var l,t,r,q,a,p,h,o,j,w,b={boxId:"superbox",boxClasses:"",overlayOpacity:0.8,boxWidth:"1200",boxHeight:"400",loadTxt:"",closeTxt:"X",prevTxt:"Previous",nextTxt:"Next",beforeShow:function(){}},x={},m=false,s=i([]);
...
a=i('<p class="close" style="float:right;margin-bottom: 10px;cursor: pointer;"><a><strong><span>'+w.closeTxt+"</span></strong></a></p>").prependTo(q).find("a");
