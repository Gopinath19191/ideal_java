    ...
    <div id="container">
        <div id="">
            <div class="container_inner" style="margin: 30px 0 24px;">
                <p class="page_heading"><span class="heading">Approve Client</span> </p>
            </div>
                    ...
                    <table  id="formTable" border="0" align="center">
                        <tbody>
                            ...
                            <tr class="">
                                ...
                                <td  style="text-align:left">
                                    <label class="headLabel">Client Category</label>
                                </td>
                                <td  style="text-align:left">
...
<!--                            <tr class="">
                            ...
                            <tr class="">
                                ...
                                <td  style="text-align:left">
                                    <label class="">About Client</label>
                                </td>
                                <td  style="text-align:left">
                            ...
                            <tr class="">
                                ...
                                <td  style="text-align:left">
                                    <textarea cols="20" rows="2" style=" width: 158px;height: 55px;" name="remarks" id="remarks"  maxlength="500"  minlength="10" onblur="textLimit(this,500);" onkeyup="textLimit(this,100)" class="textbox_new required address minlength maxlength resizableTextArea ui-resizable">${selectedCustomerData[0].remarks}</textarea>
                                </td>
                                <td  style="text-align:left">
                                    <label class="">Terms of Payment</label>
                                </td>
                                <td  style="text-align:left">
                                    <input type="text" name="termsOfPayment" id="termsOfPayment" class="numberDE required textbox_new" value="${selectedCustomerData[0].termsOfPayment}">Days
                                </td>
                ...
                <div class="buttonAlignment">
                    <div class="buttonAlignment" id="btnGroup">
                        ...
                        <c:if test="${selectedCustomerData[0].status == 'd' || selectedCustomerData[0].status == 'm'}">
                            <input type="submit" name="customerApproveButton" id="approveBtn" style="width: 90px;" value="Approve" class="qualitysubmit" onclick="return disableApprove('approveBtn','rejectBtn','btnCancel');">
                            <input type="submit" name="customerRejectButton" id="rejectBtn" value="Reject" class="qualitycancel" onclick="return disableReject('approveBtn','rejectBtn','btnCancel');">
                        </c:if>

                        <input type="button" name="btnCancel" id="btnCancel" value="Back" class="qualityback" onclick="javascript: location.href='authenticate.htm?empId=${employee_no}&modId=76'">
                    </div>
                </div>                                  
            </form>
        </div>
