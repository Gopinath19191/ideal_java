...
//              file1.setAttribute("style", "visibility : hidden");
      ...
      <body onload="changeTabClass('aaForm');">
        ...
        <div class="submenuwrap">
            ...
            <div class="contentwrap">
                    <div class="contentarea">
                        ...
                        <table width="100%" class="qpdSearch">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><span class="displayText">
                                        <select name="appraisalYear" id="appraisalYear" class="required selectbox form2" style="width: 5em" onchange="fetchAppraiseeInfo()">
                    ...
                    <div class="formarea">
                        <form action="${pageContext.request.contextPath}/com/defiance/ideal/qpd/appraisee/save.do" method="post" name="appraiseeForm" id="appraiseeForm" enctype="multipart/form-data">
                            <div>
                                    ...
                                    <table id="topAchievements" width="100%" align="center" border="0" style="border-collapse: collapse">
                                        ...
                                        <tr>
                                            ...
                                            <td class="tableData" style="text-align: center">
                                              ...
                                              <%--<a href="javascript:void(0)" class="removeMore" onclick="removeRow(this,0,'topAchievements')"></a>--%>
                                              <img title="Remove" onclick="removeRow(this,0,'topAchievements')" src="${pageContext.request.contextPath}/css/images/delete-icon.png" />
                                            </td>
                                            </c:if>
                                        </tr>
                                        </c:if>
                                        <c:forEach items="${topAchievements}" var="topAchievementsDetail" varStatus="taindex">
                                             <tr>
                                                <td class="tableData">
                                                    <textarea ${readonlystatus} cols="" rows="" class="bigText kraData" id="keyResultAreas${taindex.index}" name="keyResultAreas[]">${topAchievementsDetail.keyResultArea}</textarea>
                                               ...
                                               <%-- <input type="hidden" name="topAchievementsId[]" id="topAchievementsId${taindex.index}" value="${topAchievementsDetail.achievementId}" />
                                                <input type="hidden" class="statusCheck" id="topAchievementsStatus${taindex.index}" name="topAchievementsStatus[]" value="undeleted" />--%>
                                                <%--<a href="javascript:void(0)" class="removeMore" onclick="removeRow(this,${taindex.index},'topAchievements')"></a>--%>
                                                <img title="Remove" onclick="removeRow(this,${taindex.index},'topAchievements')" src="${pageContext.request.contextPath}/css/images/delete-icon.png" />
                                                </td>
                                                </c:if>
                                            </tr>
                                        </c:forEach>
                                    ...
                                    <c:if test="${appraiseeDetails.submitStatus<2}">
                                    <%--<input type="button" class="buttons addmore" onclick="addRow('topAchievements','topAchievementsId')" value="Add achievements" />--%>
                                    <input type="button" class="buttons addmore" onclick="addRow('topAchievements','topAchievementsId')" value="Add" />
                                    <input type="hidden" id="topAchievementsCount" name="topAchievementsCount" value="" />
                                    </c:if>
                            </div>
                            <br>
                            ...
                            <table width="100%" border="0">
                                <thead>
                                    <tr class="formarea_header">
                                        <th width="100px;"></th>
                                        <th width="401px;">Performance Indicator</th>
                                        <%--<th>MEASUREMENT CRITERIA</th>--%>
                                        <th width="20px;">Weightage</th>
                                        <th>Key Achievements - Comments</th>
                                        <c:if test="${appraiseeDetails.submitStatus>=1}">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${kraData}" var="datum" varStatus="item">
                                        ...
                                        <tr class="${rowDisplay}">
                                            ...
                                            <td>
                                                <%--<textarea class="customRequired resizableTextArea appraiseeCommentsBox" style="width: 335px;height: 67px;" cols="15" rows="3" name="appraiseeComments" id="appraiseeComments${datum.kraQtrId}" ${readonlystatus} onchange="removeErrorDiv(this)">${datum.selfComments}</textarea>--%>
                                                <textarea class="customRequired resizableTextArea appraiseeCommentsBox" style="width: 335px;height: 67px;" cols="15" rows="3" name="appraiseeComments" id="appraiseeComments${datum.kraQtrId}" ${readonlystatus}>${datum.selfComments}</textarea>
                            ...
                            <div>
                                    ...
                                    <table id="developmentNeeds" width="100%" align="center" border="0" style="border-collapse: collapse">
                                        <tr>
                                            <th>
                                                Development Needs (Add only one development need per row)
                                            </th>
                                            <c:if test="${appraiseeDetails.submitStatus<2}">
                                            <th width="54px">
                                                Actions
                                        ...
                                        <tr>
                                            <td class="tableData">
                                                <textarea ${readonlystatus} cols="" rows="" class="bigText develNeed" id="devNeedData0" name="devNeedData[]"></textarea></td>
                                            <c:if test="${appraiseeDetails.submitStatus<2}">
                                            <td class="tableData" style="text-align: center">
                                               ...
                                               <img title="Remove" onclick="removeRow(this,0,'developmentNeeds')" src="${pageContext.request.contextPath}/css/images/delete-icon.png" />
                                            </td>
                                            </c:if>
                                        </tr>
                                        </c:if>
                                        <c:forEach items="${developmentNeeds}" var="developmentNeedsDetail" varStatus="dnindex">
                                             <tr>
                                                <td class="tableData">
                                                    <textarea ${readonlystatus} cols="" rows="" class="bigText develNeed" id="devNeedData${dnindex.index}" name="devNeedData[]">${developmentNeedsDetail.developmentNeed}</textarea>
                                                ...
                                                <td class="tableData" style="text-align: center">
                                                    <%--<input type="hidden" name="developmentNeedsId[]" id="developmentNeedsId${dnindex.index}" value="${developmentNeedsDetail.needsId}" />
                                                    <input type="hidden" class="statusCheck" id="developmentNeedsStatus${dnindex.index}" name="developmentNeedsStatus[]" value="undeleted" />--%>
                                                    <img title="Remove" onclick="removeRow(this,${dnindex.index},'developmentNeeds')" src="${pageContext.request.contextPath}/css/images/delete-icon.png" />
                                                </td>
                                                </c:if>
                                            </tr>
                                        </c:forEach>
                                    ...
                                    <input type="button" class="buttons addmore" onclick="addRow('developmentNeeds','developmentNeedsId')" value="Add" />
                                    <input type="hidden" id="developmentNeedsCount" name="developmentNeedsCount" value="" />
                                    </c:if>
                            </div>
                            <br>
                            <div>
                                    ...
                                    <table id="goalSheet" width="100%" align="center" border="0" style="border-collapse: collapse">
                                        <tr>
                                            <th>
                                                <%--Goal Sheet For 2011-2012 (Add only one goal per row)--%>
                                                Goal Sheet For  ${appraisalYear}-${appraisalYear+1} (Add only one goal per row)
                                            </th>
                                            <c:if test="${appraiseeDetails.submitStatus<2}">
                                            <th width="54px">
                                                Actions
                                        ...
                                        <tr>
                                            ...
                                            <td class="tableData" style="text-align: center">
                                                ...
                                                <img title="Remove" onclick="removeRow(this,0,'goalSheet')" src="${pageContext.request.contextPath}/css/images/delete-icon.png" />
                                            </td>
                                            </c:if>
                                        </tr>
                                        </c:if>
                                        <c:forEach items="${goalSheet}" var="goalSheetDetail" varStatus="glIndex">
                                             <tr>
                                                <td class="tableData">
                                                    <textarea ${readonlystatus} cols="" rows="" class="bigText goalData" id="goalData${glIndex.index}" name="goalData[]">${goalSheetDetail.glData}</textarea>
                                                ...
                                                <td class="tableData" style="text-align: center">
                                                   <%-- <input type="hidden" name="goalId[]" id="goalId${glIndex.index}" value="${goalSheetDetail.glId}" />
                                                    <input type="hidden" class="statusCheck" id="goalSheetStatus${glIndex.index}" name="goalSheetStatus[]" value="undeleted" />--%>
                                                    <img title="Remove" onclick="removeRow(this,${glIndex.index},'goalSheet')" src="${pageContext.request.contextPath}/css/images/delete-icon.png" />
                                                </td>
                                                </c:if>
                                            </tr>
                                        </c:forEach>
                                    ...
                                    <input type="button" class="buttons addmore" onclick="addRow('goalSheet','goalId')" value="Add" />
                                    <input type="hidden" id="goalSheetCount" name="goalSheetCount" value="" />
                                    </c:if>
                            </div>
                                    <br>
                                        ...
                                        <td>
                                            <div id="buttonDisplay" style="display: block;" >
                                                <c:if test="${KraIdCount==0}">
                                                    <input class="buttons exportbutton" id="exportExcel" value="Export to Excel" type="submit" name="button" />
                                                </c:if>
                                                <c:if test="${appraiseeDetails.submitStatus<2 && dateExpired=='notexpired'}">
                                                    ...
                                                    <input class="buttons submitbutton"  style="width: 167px" type="submit" value="Submit for Review" name="button" onclick="return validateComments()" >
...
<!--                                            Technology Training Recommended By Appraiser --->
                                        ...
                                        <td class="commentText">
                                            ${appraiseeDetails.discussionDate}
                                        </td>
                                    </tr>
                            </table>
</c:if>
