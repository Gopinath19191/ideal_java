...
<html>
    ...
    <body>
        <div id="main_container" style=" margin-top: 20px;">
            ...
            <br>
            <div>
                <table class="dataTable" border="1" style="width:1000px;" RULES=NONE FRAME=BOX>
                    <tr>
                        <th>
                            Modified By
                        </th>
                        ...
                        <c:choose>
                            ...
                            <td>
                                ...
                                <c:if test="${list.module_name eq 'BAND & DESIGNATION'}">
                                    <a href="downloadAuditExcel.htm?filename=${list.file_name}" ><c:out value="BAND & DESIGNATIO"></c:out></a> 
                                </c:if>
                            </td>
                        </tr>
