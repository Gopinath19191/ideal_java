...
//        System.out.println("mailMessage = " + fromAddress);
    ...
    public boolean smtpMailMultipleAttachment(final String mailTo, final String mailSubject, final String mailMessage, final String mailCC, final String attachment1, final String attachment2) throws Exception {
        final Session mailSession = Session.getInstance(emailProps, new javax.mail.Authenticator() {
            @Override
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication(fromAddress, mailPassword);
        ...
        if (attachment1 != null && attachment2 != null) {
            ...
            addAttachment(multipart, attachment1);
