<%-- 
    ...
    Created on : 13 Jul, 2022, 2:21:39 PM
    Author     : 18462
--%>
...
<html>
    ...
    <script type="text/javascript">
       ...
       function downloadExcel(){
            ...
            $.ajax({
                type: 'POST',
                url: "getPrLastBilledReportXL.htm",
                success: function(response) {                        
                    $("#prLastBilledReport").submit();
                }
            });
        }
    ...
    <body>
        ...
        <div id="container">          
            ...
            <div class="tabletools">
                <form action="prLastBilledReportDownload.htm" id="prLastBilledReport" name="prLastBilledReport" method="POST" onclick="downloadExcel()">               
