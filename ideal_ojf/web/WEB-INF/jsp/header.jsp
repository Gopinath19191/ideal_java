...
<html>
    <head>
        ...
        <script type="text/javascript" src="javascript/jquery.form.2.49.js"></script>
        <script type="text/javascript" src="javascript/jquery-ui-1.8.5.custom.min.js"></script>
        <script type="text/javascript" src="javascript/jquery.autoSuggest.mod.js"></script>
        <script type="text/javascript" src="javascript/jquery.validate.1.7.mod.js"></script>
        <script type="text/javascript" src="javascript/additional-methods.js"></script>
        <script type="text/javascript" src="javascript/number_validate.js"></script>
