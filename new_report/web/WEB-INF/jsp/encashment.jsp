...
<html>
    <head>
        <title>Employee Encashment Report </title>
    ...
    <script type="text/javascript">
        function getExcelReport(){
            $('#reportPage').attr("action", "getEncashXL.htm");
        ...
        function getFilterList(){
            $('#reportPage').attr("action", "encashment.htm");
            if($("#employee_search").val() == 'Search by Employee Number or First Name or Last name'){
                document.getElementById("employee_id").value = "";
            }
            document.reportPage.submit();
                        ...
                        <c:if test="${fn:length(leave)>0}">
                            ...
                            <c:forEach items="${leave}" var="item">
                                ...
                                <tr class="row-even">
                                    ...
                                    <td>${fn:substring(item.financialYear,0,4)}</td>
