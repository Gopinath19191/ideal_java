...
<div id="container">
        ...
        <div id="datadisplay">
            ...
            <tr>
                <td>9</td>
                <td><a href="javascript:void(0)" onclick="printJFDetails('${pageContext.request.contextPath}/defianceWorkDetails.htm',${param.jfId})">Defiance Work Related Details</a></td>
            </tr>
            <tr>
                <td>10</td>
