...
public class LoginBOImplClientInitializer
extends org.apache.beehive.controls.runtime.bean.ClientInitializer
{
    ...
    static
    {
        try
        {
            _controlObjField = com.defiance.ideal.login.bo.LoginBOImpl.class.getDeclaredField("controlObj");
    ...
    com.defiance.ideal.login.bo.LoginBOImpl client)
    {
        try
        {
            String __bc_id;
            ...
            //
            __bc_id = "controlObj";
            com.defiance.ideal.login.dao.LoginDAOBean _controlObj = (cbc == null ? null : (com.defiance.ideal.login.dao.LoginDAOBean)cbc.getBean(__bc_id));
            if (_controlObj == null)
            _controlObj = (com.defiance.ideal.login.dao.LoginDAOBean) Controls.instantiate(com.defiance.ideal.login.dao.LoginDAOBean.class, getAnnotationMap(cbc, _controlObjField), cbc, __bc_id );
    ...
    public static void initialize(ControlBeanContext cbc, com.defiance.ideal.login.bo.LoginBOImpl client)
    {
