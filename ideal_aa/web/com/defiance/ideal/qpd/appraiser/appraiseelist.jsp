        ...
        <div class="submenuwrap">
           ...
           <div class="contentwrap">
            ...
            <form action="begin.do" method="post" name="appraiseeHeader" id="appraiseeHeader" >
                <div class="qpdSearch" style="margin-top: 0px;">
                    <table align="center" style="width: 20%;"  border="0">
                        <tr>
                            <td width="51%">Appraisal Year</td>
                            <td>
                                <select name="appraisalYear" id="appraisalYear" class="required selectbox" style="width: 5em" onchange="fetchAppraiseeListAppraiser()">
                         ...
                         <tr class="${rowDisplay}">
                             <td style="text-align: center">
                                 <c:choose>
                                     ...
                                     <a style="color: #4C83B3;font-size: 12px;font-weight: bold" href="javascript:void(0)" onclick="sendAppraiseeData(${datum.appraiseeId},${datum.bandId},${datum.submitStatus},'${datum.appraiseeName}','${datum.appraiseeJoiningDate}','${datum.appraiseeStatus}','${datum.appraiseeNumber}','${datum.qpdId}')">${datum.appraiseeNumber}</a>
                                     </c:when>
                                     <c:otherwise>
