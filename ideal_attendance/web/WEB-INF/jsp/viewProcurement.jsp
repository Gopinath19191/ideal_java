<%-- 
    Document   : viewProcurement
    Created on : 4 Dec, 2017, 12:41:34 PM
    Author     : 16221
--%>
...
<html>
    ...
    <body>
        <div class="container_inner"> 
            <div class="page_heading">View Purchase Request</div>
            <div class="listLink">
                <img src="/ideal_attendance/images/icon_list.png" title="List Procurement" alt="List Procurement">
                <a style="text-decoration:none;color: #4C83B3;" target="_self" href="procurementList.htm?status=${procurementDetails.get(0).status}">Purchase Request List</a>
            </div>
        </div>
        <form action="approveProcurement.htm" name="saveDetails" id="approveDetails" method="post" enctype="multipart/form-data" autocomplete="off">
            <div id="content">
                ...
                <div class="buttonClass">
                    <input type="button" name="buttonCancel" id="buttonCancel" value="Back" class="cancelbutton" onclick="javascript: location.href='procurementList.htm?status=${procurementDetails.get(0).status}'"/>
                    <c:if test="${result.get(0).status=='s'}">
                        <input type="button" name="buttonEdit" id="buttonEdit" value="Edit" class="editbutton"/>
                    </c:if>
                </div>
            </div>
        </form>
