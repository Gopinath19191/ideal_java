...
public class AppraiseeBOImplClientInitializer
extends org.apache.beehive.controls.runtime.bean.ClientInitializer
{
    ...
    static
    {
        try
        {
            _controlObjField = com.defiance.ideal.qpd.appraisee.bo.AppraiseeBOImpl.class.getDeclaredField("controlObj");
    ...
    com.defiance.ideal.qpd.appraisee.bo.AppraiseeBOImpl client)
    {
        try
        {
            String __bc_id;
            ...
            //
            __bc_id = "controlObj";
            com.defiance.ideal.qpd.appraisee.dao.AppraiseeDAOBean _controlObj = (cbc == null ? null : (com.defiance.ideal.qpd.appraisee.dao.AppraiseeDAOBean)cbc.getBean(__bc_id));
            if (_controlObj == null)
            _controlObj = (com.defiance.ideal.qpd.appraisee.dao.AppraiseeDAOBean) Controls.instantiate(com.defiance.ideal.qpd.appraisee.dao.AppraiseeDAOBean.class, getAnnotationMap(cbc, _controlObjField), cbc, __bc_id );
    ...
    public static void initialize(ControlBeanContext cbc, com.defiance.ideal.qpd.appraisee.bo.AppraiseeBOImpl client)
    {
