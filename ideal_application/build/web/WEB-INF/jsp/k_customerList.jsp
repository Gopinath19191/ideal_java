...
<body onload="">
    ...
    <div id="container">
        <div class="container_inner">
            <p class="page_heading" style="margin-left: 36px;"><span class="heading">Client list</span> </p>
        </div>
...
<!--                <form name="customerReportPage" id="customerReportPage" action="getCustomerXL.htm" method="POST">
                ...
                <form name="reportForm" id="reportForm" action="accrualreport.htm" method="POST">
                    <a class="add" onclick="javascript: location.href='authenticate.htm?empId=${employee_no}&modId=75'" target="_self" style="text-decoration:none;cursor: pointer;" title="Add Request">Add Client</a>
                </form>    
            </div>
