...
public class ManagerBOImplInitializer
extends org.apache.beehive.controls.runtime.bean.ImplInitializer
{
    ...
    */
    ...
    {
        com.defiance.ideal.qpd.managers.bo.ManagerBOImpl __bc_impl = (com.defiance.ideal.qpd.managers.bo.ManagerBOImpl)target;
        // DO NOT DELEGATE TO SUPERCLASS HERE.  THE CONTROL CLIENT INIT HIERARCHY
        // WILL INITIALIZE ALL THE WAY DOWN TO THE BASE CLASS!
        
        try
        {
            com.defiance.ideal.qpd.managers.bo.ManagerBOImplClientInitializer.initialize(bean.getControlBeanContext(), __bc_impl);
        }
