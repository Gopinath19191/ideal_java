...
<body onload="changeTabClass('aaTrigger');" onkeypress="return noenter()">
        ...
        <div class="contentwrap">
            <div class="contentarea">
                <form action="begin.do" method="POST" name="employeeFilterForm" id="employeeFilterForm" >
                    <div class="qpdSearch" style="width: 97%;height: 144px;" >
                        <table width="100%">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="appraiserId" id="appraiserId" class="selectbox"  >
                                ...
                                <td><label class="requiredLabel">Joined Date &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; < </label></td>
                                <td>
                                    <input type="text" readonly name="joinedDate" id="joined_date" value="${filterData.joinedDate}"/>
                                </td>
                                <%--<td><input type="submit" class="buttons fetchbutton" value="Fetch Employees" class="toolfind"></td>--%>
                                <td><input type="submit" class="buttons toolfind" value="Go" class="toolfind"></td>
                            </tr>
                        ...
                        <table width="100%">
                            ...
                            <c:forEach items="${appraiseeData}" var="details" varStatus="rowCount">
                                ...
                                <tr class="${rowClass}">
                                    ...
                                    <td>
                                        <a href="javascript:void(0)" style="color: #4C83B3;font-size: 12px;font-weight: bold" onClick="changeAppraiseeData(${details.appraiseeId})">Change</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            <tr>
                                <td colspan="10" style="text-align: center">
                                    ...
                                    <input type="submit" class="buttons triggerbutton" style="width: 160px;" value="Trigger Appraisal" name="submitAppraisal" onclick="disableButtons()" />
