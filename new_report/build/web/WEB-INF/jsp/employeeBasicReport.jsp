<%-- 
    Document   : associate
    Created on : Oct 13, 2017, 12:43:59 PM
    Author     : 16113
--%>
<%@include file="header.jsp" %>
<html>
    <head>
        <title>Executive Associate Report</title>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#joinedStartDate").mouseover(function() {
                $("#from_date").html("<b>From Date</b>");
            });
            $("#joinedStartDate").mouseout(function() {
                $("#from_date").html("");
            });
            $("#joinedEndDate").mouseover(function() {
                $("#to_date").html("<b>To Date</b>");
            });
            $("#joinedEndDate").mouseout(function() {
                $("#to_date").html("");
            });
        });
        ...
        function getExcelReport() {
            ...
            $('#employeereportPage').attr("action", "EmployeeExcelexport.htm");
            document.employeereportPage.submit();
        }
        function getFilterList() {
            if(selectedEmpStatus() == false){
                return false;
            }
            $('#employeereportPage').attr("action", "exEmployeeList.htm");
    ...
    <body>
        ...
        <div id="container">
            ...
            <div class="tabletools">
                <form action="#" name="employeereportPage" method="post" id="employeereportPage">
                    ...
                    <table id="searchForm" width="100%">
                        ...
                        <tr style="height: 30px">
                            ...
                            <c:if test="${result.sbu!=''}"> 
                                <td id="subPractice" style="width: 24%" >
                        ...
                        <tr style="height: 30px">
                            <td>
                                <label for="subSbu" ><b>Practice</b></label>
                            ...
                            <td>
                                <div id="from_date" style="padding-left: 140px;color: green;"></div>
                            </td>
                            <td>
                                <div id="to_date" style="padding-left: 40px;color: green;"></div>
                            </td>
                        </tr>
                        </tbody>
                    </table>
