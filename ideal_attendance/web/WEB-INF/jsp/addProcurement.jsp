<%-- 
    Document   : addProcurement
    Created on : 25 Nov, 2017, 3:20:55 PM
    Author     : 16221
--%>
...
//            }
            ...
            if(rec_contact_no=="" || rec_contact_no==null){
                ...
                error++;
            }else if(rec_contact_no.length<10){
                $("#recipientContactNumber").css({"outline": "1px solid red"});
                $("#recipientNumberError").css({"display": "block"});
                error++;
            }else{
...
//            }
        ...
        function addRowItems(currentRow) {
            ...
            tr+='<td style="width:57px;"><input type="text" id="quantityCount_'+rowId+'" class="iteam_qnty" name="iteams_quantity" style="width:50px;" onpaste="return false" onkeypress="return blockNonNumbers(this, event, true, false);" onkeyup="return extractNumber(this,0,false);"/></td>';
            tr+='<td style="width:107px;"><input type="text" class="checkval" id="quantityAmount_'+rowId+'" name="iteams_amount" style="width:100px;" onpaste="return false" onChange="calculateTotal()" onkeypress="return blockNonNumbers(this, event, true, false);" onkeyup="return extractNumber(this,0,false);"/></td>';
        ...
        function addRowAttachment(currentRow) {
            ...
            tr+='<td>';
            tr+='<select class="doctype" id="DocumentType_'+rowId+'" name="attachments_type">';
            ...
            tr+='</select>';
            tr+='</td>';
            tr+='<td><textarea class="docdesc" rows="4" cols="50" Style="width:230px;" id="attachmentDescription_'+rowId+'" name="attachments_description" onpaste="return false"></textarea></td>';
            tr+='<td><input type="file" class="docfile" id="fileAttachment_'+rowId+'" name="attachmentValue'+rowId+'" multiple="true"></td>';
    ...
    <body>
        ...
        <div class="container_inner"> 
            <div class="page_heading">Add Purchase Request</div>
            <div class="listLink">
        ...
        <form action="saveProcurement.htm" name="saveDetails" id="saveDetails" method="post" enctype="multipart/form-data" autocomplete="off">
            <div id="content">
                ...
                <fieldset id ="procurementDetails">
                    ...
                    <table id="procurement_table">
                        <tr>
                            ...
                            <td>
                                <c:if test="${result.get(0).status=='s'}">
                                    <input type="text" id="requestorDate" name="requested_date" value="${result.get(0).requested_date}" disabled="disabled"/>
                                </c:if>
                                <c:if test="${result.get(0).status==null}">
                                    <input type="text" id="requestorDate" name="requested_date" value="${employeeDetails.get(0).request_date}" disabled="disabled"/>
                                </c:if>
                        ...
                        <tr>
                            ...
                            <td>
                                <c:if test="${result.get(0).status==null}">
                                    <input type="text" id="recipientContactNumber" name="recipient_contact_number" pattern=".{10,}"   required title="10 characters minimum" onkeypress="return blockNonNumbers(this, event, true, false);"/>
                                </c:if>
                                <c:if test="${result.get(0).status!=null}">
                                    <input type="text" id="recipientContactNumber" name="recipient_contact_number" pattern=".{10,}"   required title="10 characters minimum" onkeypress="return blockNonNumbers(this, event, true, false);" value="${result.get(0).recipient_contact_number}"/>
                                </c:if>
                                <p id="recipientNumberError" class="errorMessage">Mobile Number can't be empty</p>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p id="procurementTypeError" class="errorMessage">Please select Purchase Type</p>
                            </td>
                            <td>
                                <label>Request Type</label><font color="red">*</font>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p id="deliveryAddressError" class="errorMessage" style="margin-top: 50px;">Delivery Address can't be empty</p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <c:if test="${result.get(0).remarks==null}">
                                    <textarea type="text" id="remarksField" name="remarks" style="min-width:225px;max-width: 225px;max-height: 100px;"></textarea>
                                </c:if>
                                <c:if test="${result.get(0).remarks!=null}">
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${IteamDetails}" var="data" varStatus="dataStatus">
                                <tr id="TR_${dataStatus.count}" class="rowCount">
                                    ...
                                    <td style="width:57px;"><input type="text" id="quantityCount_${dataStatus.count}" class="iteam_qnty" name="iteams_quantity" style="width:50px;" onkeypress="return blockNonNumbers(this, event, true, false);" onkeyup="return extractNumber(this,0,false);" value="${data.iteam_quantity}"/></td>
                                    <td style="width:107px;"><input type="text" class="checkval" id="quantityAmount_${dataStatus.count}" name="iteams_amount" style="width:100px;" onChange="calculateTotal()" onkeypress="return blockNonNumbers(this, event, true, false);" onkeyup="return extractNumber(this,0,false);" value="${data.iteam_amount}"/></td>
                            ...
                            <c:if test="${empty(IteamDetails)}">
                                <tr id="TR_1" class="rowCount">
                                    ...
                                    <td style="width:57px;"><input type="text" id="quantityCount_1" class="iteam_qnty" name="iteams_quantity" style="width:50px;" onpaste="return false" onkeypress="return blockNonNumbers(this, event, true, false);" onkeyup="return extractNumber(this,0,false);"/></td>
                                    <td style="width:107px;"><input type="text" class="checkval" id="quantityAmount_1" name="iteams_amount" style="width:100px;" onpaste="return false" onChange="calculateTotal()" onkeypress="return blockNonNumbers(this, event, true, false);" onkeyup="return extractNumber(this,0,false);"/></td>
                        ...
                        <tbody>
                            ...
                            <c:if test="${empty(AttachmentDetails)}">
                                <tr id="TA_1">
                                    ...
                                    <td>
                                        <select class="doctype" id="DocumentType_1" name="attachments_type">
                                        <option value="">-- Select Document Type --</option>
                                        <c:forEach items="${DocumentType}" var="DocumentType" varStatus="i">
                                    ...
                                    <td><textarea class="docdesc" rows="4" cols="50" Style="width:230px; min-width:230px;max-width:230px;" id="attachmentDescription_1" name="attachments_description" onpaste="return false"></textarea></td>
