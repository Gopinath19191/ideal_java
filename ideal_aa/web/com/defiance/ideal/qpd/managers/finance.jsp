        ...
        <form action="financeAction.do" method="post" name="saveReview" id="saveReview" >
          <div class="contentarea">
              ...
              <div class="qpdSearch" style="height: 25px;">
                  <table width="30%" id="apprMaster" align="center" border="0" cellpadding="0" cellspacing="0" >
                      <tr align="center">
                          <td width="34%">Appraisal Year</td>
                          <td>
                              <select name="appraisalYear" id="appraisalYear" class="required selectbox" style="width: 5em" onchange="fetchAppraiseeListFinance()">
...
<!--                                                <td><a style="color: #4C83B3;font-size: 12px;font-weight: bold" href="javascript:void(0)" onclick="setAppraiseeData(${tes.appraiseeId},${tes.bandId},${appraisalQuarterFinance},${appraisalYearFinance},'${tes.appraiserName}',${tes.appraiseeEmpId},${tes.departmentId})">${tes.appraiseeEmpId}</a></td>-->
                                             <td><span class="displayText">${tes.appraiseeEmpId}</td>
