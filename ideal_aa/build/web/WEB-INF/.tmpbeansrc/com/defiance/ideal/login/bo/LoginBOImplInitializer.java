...
public class LoginBOImplInitializer
extends org.apache.beehive.controls.runtime.bean.ImplInitializer
{
    ...
    */
    ...
    {
        com.defiance.ideal.login.bo.LoginBOImpl __bc_impl = (com.defiance.ideal.login.bo.LoginBOImpl)target;
        // DO NOT DELEGATE TO SUPERCLASS HERE.  THE CONTROL CLIENT INIT HIERARCHY
        // WILL INITIALIZE ALL THE WAY DOWN TO THE BASE CLASS!
        
        try
        {
            com.defiance.ideal.login.bo.LoginBOImplClientInitializer.initialize(bean.getControlBeanContext(), __bc_impl);
        }
