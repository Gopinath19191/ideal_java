...
public class AppraiserDAOBean
extends org.apache.beehive.controls.runtime.bean.ControlBean
implements com.defiance.ideal.qpd.appraiser.dao.AppraiserDAO
{
    ...
    static
    {
        ...
        try
        {
            _getSubmitStatusMethod = com.defiance.ideal.qpd.appraiser.dao.AppraiserDAO.class.getMethod("getSubmitStatus", new Class [] {int.class, int.class, int.class});
            _methodParamMap.put(_getSubmitStatusMethod, new String [] { "appraiseeId", "appraisalQuarter", "appraisalYear" });
            _getAchievementsDataMethod = com.defiance.ideal.qpd.appraiser.dao.AppraiserDAO.class.getMethod("getAchievementsData", new Class [] {int.class, int.class});
            _methodParamMap.put(_getAchievementsDataMethod, new String [] { "appraisalYear", "appraiseeId" });
            _getAppraiseeListMethod = com.defiance.ideal.qpd.appraiser.dao.AppraiserDAO.class.getMethod("getAppraiseeList", new Class [] {int.class, int.class, int.class});
            _methodParamMap.put(_getAppraiseeListMethod, new String [] { "employeeId", "appraisalYear", "appraisalQuarter" });
            _getGoalDataMethod = com.defiance.ideal.qpd.appraiser.dao.AppraiserDAO.class.getMethod("getGoalData", new Class [] {int.class, int.class});
            _methodParamMap.put(_getGoalDataMethod, new String [] { "appraisalYear", "appraiseeId" });
            _getDevelopmentDataMethod = com.defiance.ideal.qpd.appraiser.dao.AppraiserDAO.class.getMethod("getDevelopmentData", new Class [] {int.class, int.class});
            _methodParamMap.put(_getDevelopmentDataMethod, new String [] { "appraisalYear", "appraiseeId" });
            _updateAppraiseeStatusMethod = com.defiance.ideal.qpd.appraiser.dao.AppraiserDAO.class.getMethod("updateAppraiseeStatus", new Class [] {int.class, int.class, int.class, int.class, java.lang.String.class});
            ...
            _getKraDataMethod = com.defiance.ideal.qpd.appraiser.dao.AppraiserDAO.class.getMethod("getKraData", new Class [] {int.class, int.class, int.class, int.class, int.class});
            ...
            _updateAppraiseeDataMethod = com.defiance.ideal.qpd.appraiser.dao.AppraiserDAO.class.getMethod("updateAppraiseeData", new Class [] {com.defiance.ideal.qpd.appraiser.dto.AppraiserRatingFormDTO.class});
    ...
    */
    public AppraiserDAOBean(ControlBeanContext context, String id, PropertyMap props)
    {
        this(context, id, props, com.defiance.ideal.qpd.appraiser.dao.AppraiserDAO.class);
    }
    ...
    */
    protected AppraiserDAOBean(ControlBeanContext context, String id, PropertyMap props, Class controlClass)
    {
    ...
    */
    ...
    /**
    * Implements com.defiance.ideal.qpd.appraiser.dao.AppraiserDAO.getSubmitStatus
    */
    public  com.defiance.ideal.qpd.appraiser.dto.AppraiseeListDTO getSubmitStatus(int appraiseeId, int appraisalQuarter, int appraisalYear) 
    {
        ...
        com.defiance.ideal.qpd.appraiser.dao.AppraiserDAO __bc_target = (com.defiance.ideal.qpd.appraiser.dao.AppraiserDAO)ensureControl();
    ...
    /**
    * Implements com.defiance.ideal.qpd.appraiser.dao.AppraiserDAO.getAchievementsData
    */
    ...
    /**
    * Implements com.defiance.ideal.qpd.appraiser.dao.AppraiserDAO.getAppraiseeList
    */
    ...
    /**
    * Implements com.defiance.ideal.qpd.appraiser.dao.AppraiserDAO.getGoalData
    */
    ...
    /**
    * Implements com.defiance.ideal.qpd.appraiser.dao.AppraiserDAO.getDevelopmentData
    */
    ...
    /**
    * Implements com.defiance.ideal.qpd.appraiser.dao.AppraiserDAO.updateAppraiseeStatus
    */
    ...
    /**
    * Implements com.defiance.ideal.qpd.appraiser.dao.AppraiserDAO.getKraData
    */
    ...
    /**
    * Implements com.defiance.ideal.qpd.appraiser.dao.AppraiserDAO.updateAppraiseeData
    */
