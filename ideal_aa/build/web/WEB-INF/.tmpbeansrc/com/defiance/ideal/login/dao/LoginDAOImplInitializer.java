...
public class LoginDAOImplInitializer
extends org.apache.beehive.controls.runtime.bean.ImplInitializer
{
    ...
    */
    ...
    {
        com.defiance.ideal.login.dao.LoginDAOImpl __bc_impl = (com.defiance.ideal.login.dao.LoginDAOImpl)target;
        // DO NOT DELEGATE TO SUPERCLASS HERE.  THE CONTROL CLIENT INIT HIERARCHY
        // WILL INITIALIZE ALL THE WAY DOWN TO THE BASE CLASS!
        
        try
        {
            com.defiance.ideal.login.dao.LoginDAOImplClientInitializer.initialize(bean.getControlBeanContext(), __bc_impl);
        }
