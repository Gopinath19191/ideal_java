...
public class AppraiseeDAOImplInitializer
extends org.apache.beehive.controls.runtime.bean.ImplInitializer
{
    ...
    */
    ...
    {
        com.defiance.ideal.qpd.appraisee.dao.AppraiseeDAOImpl __bc_impl = (com.defiance.ideal.qpd.appraisee.dao.AppraiseeDAOImpl)target;
        // DO NOT DELEGATE TO SUPERCLASS HERE.  THE CONTROL CLIENT INIT HIERARCHY
        // WILL INITIALIZE ALL THE WAY DOWN TO THE BASE CLASS!
        
        try
        {
            com.defiance.ideal.qpd.appraisee.dao.AppraiseeDAOImplClientInitializer.initialize(bean.getControlBeanContext(), __bc_impl);
        }
