                ...
                <div style="float: right;color: #4C83B3;font-weight: bold;font-size: 12px;">
                    <c:choose>
                        <c:when test="${selectedList=='processed'}">
                            ...
                            <a style="text-decoration:none;color: #4C83B3;" id="pendingRequest" target="_self" href="#">List Pending Request</a>
                        </c:when>
                        <c:when test="${selectedList=='pending'}">
                            ...
                            <a  style="text-decoration:none;color: #4C83B3;"  id="processedRequest" target="_self" href="#">List Processed Request</a>
                        </c:when>
                        <c:otherwise>
            ...
            <div class="notice_page" style="width:990px">
                ...
                <div style="padding-left:20px;">
                    <ul class="notice_page_ul">
                        <li>Please choose any of the check box before Approve/Send Back</li>
                        <li>Approved Hours  Field is mandatory for Approve/Send Back</li>
        ...
        <form id="timesheetApproval" name="timesheetApproval" action="" method="POST">
            ...
            <div class="searchBox" style="margin:  0px -121px 10px;width: 1010px;margin: 0px auto;box-sizing: border-box;">
                ...
                <table width="100%" border="0">
                    <tbody>
                        <tr>
                            <td width="12%" style="padding-left:10px;"><b>Project Name</b><span style="color:red;">*</span></td>
                    ...
                    <td width="12%"><b>Employee Name</b></td>
                    <td>
                    ...
                    <td width="12%" style="padding-left:10px;"><b>Approval Type</b></td>
...
<!--                                            <td style="text-align:center;">
                    ...
                    <c:if test="${selectedList == 'pending'}">
                        <tr class="headerCenter">
                            <c:choose>
                                <c:when test="${tableHeader == 'Non_Project_Activity'}">
                                    <th colspan="6" align="right">Total Hours</th>
                                </c:when>
                                <c:otherwise>
                                    <th colspan="7" align="right">Total Hours</th>
                                </c:otherwise>
                            </c:choose>
                            <td style="text-align:center;">
