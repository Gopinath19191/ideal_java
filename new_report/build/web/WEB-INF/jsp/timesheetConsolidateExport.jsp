<%-- 
    Document   : newjsptimesheetConsolideExport
    Created on : 22 Feb, 2018, 4:10:19 PM
    Author     : 16221
--%>
    ...
    <head>
        ...
        <script>
            ...
            function getFilterList() {
                $('#vendorExport').attr("action", "vendorConsolidateExport.htm");
                document.vendorExport.submit();
            }
            function getExportAll(){
                $('#vendorExport').attr("action", "exportConsolidateTimesheet.htm");
                document.vendorExport.submit();
            }
        ...
        <div class="container_inner" style="margin: 35px auto 0px;height:600px;width: 1000px;">
            <div class="page_heading">
                ...
                <div style="float: right;color: #4C83B3;font-weight: bold;font-size: 12px;">
                    ...
                    <a style="text-decoration:none;color: #4C83B3;" id="pendingRequest" target="_self" href="vendorContractExport.htm?page=1">Employee Timesheet List</a>
                </div>
            </div>
                        ...
                        <c:if test="${fn:length(employeeList) > 0}">
                            <table id="rmView">
                                <thead>
                                    ...
                                    <th class="date">Currency</th>
                                    <th class="date">UOM</th>
                                    <th class="date">Entity</th>
                                    <th class="workefDays">Working Days</th>
                                    <th class="workefDays">Worked Days</th>
                                    <th class="workefDays">Leave Days</th>
                                </thead>
                                <tbody>
                                    <% int i = 0;
                                        int s = 0;
