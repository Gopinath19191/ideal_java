...
<!--                                            </tr>
                                        ...
                                        <table id="momPresent" border="0" style="height: 36px;">
                                           <!--<tr id="TR2_${presentStatus.count}">-->
                                                ...
                                                <td> 
<!--                                                    <span>${list.members_present}</span>-->
                                                    <!--<input type="text" id="test"  name="test"  value=""  autocomplete="off" style="margin-top: -21px;margin-bottom: 0px;"/>-->
...
<!--                                            </tr>
                                        ...
                                        <table id="momAbsent" border="0">
                                            <tr id="TR3_${absentStatus.count}">-->
