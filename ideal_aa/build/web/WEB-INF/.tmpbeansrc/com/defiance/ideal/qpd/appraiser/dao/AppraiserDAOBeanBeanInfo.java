...
public class AppraiserDAOBeanBeanInfo
extends org.apache.beehive.controls.runtime.bean.ControlBeanInfo
{
    ...
    */
    public AppraiserDAOBeanBeanInfo()
    {
        super(com.defiance.ideal.qpd.appraiser.dao.AppraiserDAOBean.class);
    }
    
    /**
    * Protected constructor used if this BeanInfo class is extended.
    */
    protected AppraiserDAOBeanBeanInfo(Class beanClass)
    {
        super(beanClass);
    }
    ...
    {
        BeanDescriptor bd = new BeanDescriptor(com.defiance.ideal.qpd.appraiser.dao.AppraiserDAOBean.class);
        bd.setName( "AppraiserDAOBean" );
        bd.setDisplayName( "AppraiserDAOBean" );
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        pd = new PropertyDescriptor( "controlImplementation" , com.defiance.ideal.qpd.appraiser.dao.AppraiserDAOBean.class, "getControlImplementation", "setControlImplementation");
