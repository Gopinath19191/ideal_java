	...
	public void init() {
	 File logFile = null;
		try {
                   ...
                   masterConfigFile.load(new FileInputStream("d:\\propertyfiles\\qpdconfiguration.properties"));
             //      masterConfigFile.load(new FileInputStream("e:\\propertyfiles\\qpdconfiguration.properties"));
