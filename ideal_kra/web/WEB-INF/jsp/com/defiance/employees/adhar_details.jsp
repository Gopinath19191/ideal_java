<%-- 
    Document   : adhar_details
    Created on : 8 Sep, 2014, 12:18:01 PM
    Author     : 8000167
--%>
        ...
        <div class="contentwrap" style="height:auto;" >
            ...
            <table width="100%" border="0">
                <tbody>
                    <tr>
                        <td>
                            <form action="adharNumberSubmit.htm" name="adharNumberForm" id="adharNumberForm" method="post" onSubmit="return validateAdharNumber();">
                                        ...
                                        <c:otherwise>  
                                            ...
                                            <tr id="TR_1">
                                                <td valign ="top" align="center">
                                                    <input type="text" name="adhar_number" id="adhar_number" style="width:95%" maxlength="20" value = "${data.adhar_number}"/>
                                                    <span style="color:red;display:none;" id="adhar_number_error">*required</span>
                                                </td>
                                                <td valign ="top" align="center">
                                                    <input type="text" id="remarks" name="adhar_remarks" style="width:95%" maxlength="100" value = "${adhar_remarks}"/>
                                            ...
                                            <c:if test="${empty(result)}">
                                                <tr id="TR_1">
                                                    <td valign ="top" align="center">
                                                        <input type="text" name="adhar_number" id="adhar_number" style="width:95%" maxlength="20" />
                                                        <span style="color:red;display:none;" id="adhar_number_error">*required</span>
                                                    </td>
                                                    <td valign ="top" align="center">
                                                        <input type="text" id="remarks" name="adhar_remarks" value="" style="width:95%" maxlength="100" />
                                                        <span style="color:red;display:none;" id="remarks_error">*required</span>
                                                    </td>
                                                    <!--                                    <td align="center" align="center">
                                                                                            <img alt="Add" src="${pageContext.request.contextPath}/images/add.gif" onclick="addRow_Licence(1);" />
