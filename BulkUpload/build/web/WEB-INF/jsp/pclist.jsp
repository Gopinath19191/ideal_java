...
//                }
                ...
                $("#employee_search").autocomplete("pc_search_user.htm", {
                    minChars: 1,
                    matchContains: true
                });
            ...
            function getExcelReport() {
                ...
                $('#pcListPage').attr("action", "excelexportPcList.htm");
            ...
            function searchFeedback(pageNo) {
                ...
                if (fstartdate == null || fstartdate == "") {
                    ...
                    $('#pcListPage').attr("action", "search_consultant.htm?empname=" + empVal);
                    document.pcListPage.submit();
                    startLoading();
                }
        ...
        <div id="content">
            <div class="container_inner" style="padding-top: 60px">
                <div class="page_heading">
                    Partner Consultant
                    <div class="listLink">
                        <img src="/BulkUpload/images/add.png">
                        <a href="add_pc.htm" target="_self" style="text-decoration:none;color: #4C83B3;" href="add_pc.htm">Add Consultant</a>
                    </div>
                </div>
                    ...
                    <div id="datadisplay">
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <!--    <th align="center">Personal Address Line</th>
                                                                <th align="center">Country</th>
                                                                <th align="center">Region</th>
                                                                <th align="center">City</th>-->
                                <!--<th align="center">Aadhaar Number</th>-->
<!--                                <th align="center">Emergency Contact Person Name</th>
                                <th align="center">Relationship</th>
                                <th align="center">Contact person Mobile No</th>-->
                                <th align="center">HTL Reporting Manager</th>
                                <th align="center">Practice Group</th>
                                <!--<th align="center">Sub Practice Group</th>-->
...
<!--                                    <td>${item.contactname}</td>
                                    ...
                                    <!--<td>${item.subPracticeGroupName}</td>-->
                                    <td>${item.startdate}</td>
                                    <td>${item.enddate}</td>
                                    <td>${item.projectName}</td>
                                    <td class="actions">
                                        <a href="editConsultant.htm?pcId=${item.consultant_empid}&countryId=${item.countryId}&regionId=${item.regionId}"><img src="${pageContext.request.contextPath}/images/document-blue.png" /></a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </table>
