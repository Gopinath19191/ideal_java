...
public class AppraiseeBOImplInitializer
extends org.apache.beehive.controls.runtime.bean.ImplInitializer
{
    ...
    */
    ...
    {
        com.defiance.ideal.qpd.appraisee.bo.AppraiseeBOImpl __bc_impl = (com.defiance.ideal.qpd.appraisee.bo.AppraiseeBOImpl)target;
        // DO NOT DELEGATE TO SUPERCLASS HERE.  THE CONTROL CLIENT INIT HIERARCHY
        // WILL INITIALIZE ALL THE WAY DOWN TO THE BASE CLASS!
        
        try
        {
            com.defiance.ideal.qpd.appraisee.bo.AppraiseeBOImplClientInitializer.initialize(bean.getControlBeanContext(), __bc_impl);
        }
