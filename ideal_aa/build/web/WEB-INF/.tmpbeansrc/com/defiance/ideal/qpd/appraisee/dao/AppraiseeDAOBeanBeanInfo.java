...
public class AppraiseeDAOBeanBeanInfo
extends org.apache.beehive.controls.runtime.bean.ControlBeanInfo
{
    ...
    */
    public AppraiseeDAOBeanBeanInfo()
    {
        super(com.defiance.ideal.qpd.appraisee.dao.AppraiseeDAOBean.class);
    }
    
    /**
    * Protected constructor used if this BeanInfo class is extended.
    */
    protected AppraiseeDAOBeanBeanInfo(Class beanClass)
    {
        super(beanClass);
    }
    ...
    {
        BeanDescriptor bd = new BeanDescriptor(com.defiance.ideal.qpd.appraisee.dao.AppraiseeDAOBean.class);
        bd.setName( "AppraiseeDAOBean" );
        bd.setDisplayName( "AppraiseeDAOBean" );
    ...
    */
    ...
    throws java.beans.IntrospectionException
    {
        ...
        pd = new PropertyDescriptor( "controlImplementation" , com.defiance.ideal.qpd.appraisee.dao.AppraiseeDAOBean.class, "getControlImplementation", "setControlImplementation");
