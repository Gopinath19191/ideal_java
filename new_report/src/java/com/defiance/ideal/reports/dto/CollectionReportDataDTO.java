 ...
 * @author 14517
 */
public class CollectionReportDataDTO {
    ...
    private Date invoice_date_submission_customer;
    private Date expected_collection_date;
    ...
    public Date getExpected_collection_date() {
        return expected_collection_date;
    }

    public void setExpected_collection_date(Date expected_collection_date) {
        this.expected_collection_date = expected_collection_date;
    }

    public Date getInvoice_date_submission_customer() {
        return invoice_date_submission_customer;
    }

    public void setInvoice_date_submission_customer(Date invoice_date_submission_customer) {
