<%-- 
    Document   : timesheet_Lekage_Report
    Created on : 24 Jun, 2022, 10:21:28 AM
    Author     : 16221
--%>
...
<html>
    <head>
        <title> Timesheet Leakage Report </title>
    ...
    <script type="text/javascript">
        ...
        function downloadExcel(){
            ...
            if(from_date ==""){           
                ...
                $.ajax({
                    type: 'POST',
                    url: 'getTimesheetLekageReportXL.htm?customer_id='+customer_id+'&project_id='+project_id+'&from_date='+from_date+'&to_date='+to_date,
                    success: function(response) {  
                        stopLoading();
                        $("#timesheetLekageReport").submit();
                    }
                });
            }
        }
        ...
        $(document).ready(function(){
            ...
            $('#customerList').change(function () {
                ...
                $.ajax({
                    url: 'getTimesheetlekageProjectList.htm',
                    type: "POST",
                    async: false,
                    data: ({customer_id:customer_id}),
                    success: function(response) {
                        $("#projectList").html('').html(response);                      
                    }
                });               
            });   
        ...
        <div id="container">          
            <div class="container_inner">
                <div class="page_heading">
                    Timesheet Lekage Report
                </div>

            </div>            
            <div class="tabletools">
                <form action="timesheetLekageReportDownload.htm" id="timesheetLekageReport" name="timesheetLekageReport" method="POST">               
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td width="" style="color: #666;"><b>Customers :</b> 
                                <select id="customerList" name="customerList">
                                    <option value="0">All</option>
                                    <c:forEach items="${customerList}" var="customerList">
                                        <option value="${customerList.cust_id}">${customerList.cust_name}</option>
                                    </c:forEach>
                                </select>
                            </td>

                            <td width="" style="color: #666;"><b>Projects :</b> 
            ...
            <div class="fromMessage">
                <span id="from" style="font-size:15px" style="color:red" style="display:none"></span> 
            </div>
            <div class="toMessage">
                <span id="to" style="font-size:15px" style="color:red" style="display:none"></span>
            </div>
    </body>
</html>
