...
<head>
    <title>Associate Competency Project Monthly Worked Hours</title>
    ...
    <div id="container">
        <div class="container_inner">
            <div class="page_heading">
                Associate Competency Project Monthly Worked Hours
            </div>
        </div>
                    ...
                    <c:if test="${fn:length(filterData)!=0}">
                        <c:forEach items="${filterData}" var="filterData" varStatus="rpritr">
                            <tr>
                                ...
                                <td>
                                    ${filterData.executionModel} 
                                </td>
                                <td>
                                    ${filterData.projectStartDate} 
                                </td>
                                <td>
                                    ${filterData.projectEndDate} 
                                </td>
                                <td>
                                    ${filterData.sbu} 
                                </td>
                                ...
                                <td>
                                    ${filterData.totalAvailableHours} 
                                </td>
                                <td>
                                    <c:choose>
