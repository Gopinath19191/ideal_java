...
/*            float: right;*/
    ...
    <script>
        ...
        function exportdata(){
            $('#unbilledPage').attr("action", "exportEmployeeReport.htm");
            document.unbilledPage.submit();
        }
    </script>
    <body>
        ...
        <div id="container">
            ...
            <div id="datadisplay">
                ...
                <c:if test="${fn:length(empReport)!=0}">
                <div class="title_style">
                    Project Name : ${empReport.get(0).projectName}
                </div>
                <div class="title_style">
                    Customer Name : ${empReport.get(0).customerName}
                </div>
                <div class="title_style">
                    Employee Name : ${empReport.get(0).employeeId} - ${empReport.get(0).employeeName}
                </div>
                </c:if> 
                    ...
                    <tbody>
                        <c:if test="${fn:length(empReport)!=0}">
                            <% int i = 0;
                                int s = 0;
                            %>
                             <c:forEach items="${empReport}" var="data">
                            <% s = i % 2;
                                if (s == 0) {%>
                            <tr class="row-odd">
                                <% } else {%>
