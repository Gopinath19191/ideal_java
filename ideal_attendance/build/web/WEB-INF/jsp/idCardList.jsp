<%-- 
    Document   : idCardList
    Created on : 8 Aug, 2019, 12:59:56 PM
    Author     : 16221
--%>
                    ...
                    <table id="customerDataList"  class="display">
                        ...
                        <c:forEach items="${employee_list}" var="employeelist" varStatus="rpritr">
                            ...
                            <tr class="${rowClass}">
                                ...
                                <td>
                                    <a title="View" target="_self" style="text-decoration:none" href="${pageContext.request.contextPath}/getEmployeeDetails.htm?employee_id=${employeelist.employee_id}"><img src="${pageContext.request.contextPath}/css/images/eye.png" style="padding-left: 8px;"></a>
                                    <a title="Edit" target="_self" style="text-decoration:none" href="${pageContext.request.contextPath}/getEmployeeDetails.htm?employee_id=${employeelist.employee_id}"><img src="${pageContext.request.contextPath}/css/images/edit-icon.png" style="padding-left: 8px;"></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </table>
