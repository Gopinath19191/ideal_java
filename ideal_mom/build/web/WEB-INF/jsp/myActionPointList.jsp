                              ...
                              <c:choose>
                               ...
                               <c:choose>
                                  <c:when test="${employee_id == momObj.employee_id}"> 
                                    ...
                                    <input type="hidden" name="actionid" id ="actionid_${momObj.action_point_id}" value="${momObj.action_point_id}"> 
                                    <td align="center">
...
<!--                                                    <span> ${momObj.tracking_comments}</span>-->
                                         ...
                                         <td align="center">
                                            <select name = "actionstatus" id="actionStatus_${momObj.action_point_id}" class="actionstatus">
...
//                     i = $(value).attr('value');
//                       $("#datepicker_"+i).click(function(e){
//                       $('#check_box_'+i).attr("checked", this.checked);
//                      
//                      
//                      $("#datepicker_"+i).click(function(e){
