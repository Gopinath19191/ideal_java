...
<!--                                    <option value="">Select Year</option>-->
                     ...
                     <tr><td><label class="headLabel">Appraisee Status</label></td>
                         ...
                         <td><span class="displayText">${appraiseeInitialData.appraiseeJoiningDateForm}==${appraiseeInitialData.bandIdForm}</span></td></tr>
                     </table>
                     ...
                     <tbody>
                         ...
                         <c:forEach items="${kraData}" var="datum" varStatus="indexValue">
                             ...
                             <tr class="${rowDisplay}">
                                 ...
                                 <td>
                                     <textarea cols="15" rows="3" name="appraiserCommentsNew[]" style="width:133px;height: 142px;" class="resizableTextArea appraiseeCommentsBox" ${setDisabled}>${datum.appraiserCommentsNew}</textarea>
                                 </td>
                             </tr>
                         </c:forEach>
                         <tr>
                         ...
                         <tr>
                             ...
                             <td width="35%">
                                 ...
                                 <%--<textarea  class="alphanumericlang resizableTextArea appraiserCommentsBox" name="justifyRatingAppraiser" cols=30 rows=3 ${setDisabled}>${appraiserComments}</textarea>--%>
                                 <textarea class="resizableTextArea alphanumericlang appraiserCommentsBox" name="justifyRatingAppraiser" cols="30" rows="3" ${setDisabled}>${appraiserComments}</textarea>
                             </td>
                             <td valign="middle" style="text-align: center" width="15%">
                                 <%--Areas of improvement--%> Improvement Areas <br> (Max 250 Characters):
                             </td>
                             <td width="35%">
                                 <textarea class="resizableTextArea alphanumericlang appraiserCommentsBox" name="areasOfImprovement" cols="30" rows="3" ${setDisabled}>${appraiserObj.areasOfImprovement}</textarea>
                             </td>
                         </tr>
                         </table>
                         <%--<fieldset>
                             ...
                             <table width="100%" align="center">
                                 <tr>
                                     ...
                                     <td colspan="2" width="34%">
                                         <textarea class="resizableTextArea alphanumericlang appraiserCommentsBox" name="technologyTraining" cols="30" rows="3" ${setDisabled}>${appraiserObj.technologyTraining}</textarea>
                                     </td>
                                     <td style="text-align: center" valign="middle" width="14%">
                                         <%--Soft skill Training --%> Over All Comments <br> (Max 250 Characters) :
                                     </td>
                                     <td colspan="2" width="34%">
                                         <textarea class="resizableTextArea alphanumericlang appraiserCommentsBox" name="softskillTraining" cols="30" rows="3" ${setDisabled}>${appraiserObj.softskillTraining}</textarea>
                                     </td>
                                 </tr>
                             </table>
                         <%--</fieldset>--%>
                         ...
                         <table width="100%" align="center" border="0">
                             ...
                             <tr>
                                <td style="text-align: center;" colspan="3">
                                     ...
                                     Promotion Recommended : <input ${setDisabled} class="" type="radio" name="appraiserPromotionRecommeded" id="appraiserPromotionRecommeded" value="1" ${appPromStatusYes}  />Yes <input type="radio" ${setDisabled} class="" name="appraiserPromotionRecommeded" id="appraiserPromotionRecommeded" value="0" ${appPromStatusNo} /> No
                                 </td>
                             </tr>
                         </table>
