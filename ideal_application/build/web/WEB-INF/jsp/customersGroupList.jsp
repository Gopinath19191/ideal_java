...
<body onload="">
    ...
    <div id="container">
         <div class="container_inner">
            <p class="page_heading" style="margin-left: 16px;"><span class="heading">Customer Group list</span> </p>
        </div>
        ...
        <form name="reportForm" id="reportForm" action="accrualreport.htm" method="POST">
           ...
           <div id="container">
            <div class="goToList" style="width: 300px;margin: 8px -46px 18px;">
                <a class="add" onclick="javascript: location.href='authenticate.htm?empId=${employee_no}&modId=530'" target="_self" style="text-decoration:none;" title="Add Request">Add Customer Group</a>
<!--                <input type="button" align="middle" style="float: none" value="Add Customer Group" onclick="javascript: location.href='authenticate.htm?empId=${employee_no}&modId=530'" class="editbutton" />-->
            </div>
           </div>
            <%--<input type="text" value="${EMP_ID}" >--%>
        </form>
        <div id="datadisplay" class="formContent_new" style="width: 100%">
            <c:if test="${fn:length(customerGroupData)>0}">
...
<!--                    <th>
                    ...
                    <c:forEach items="${customerGroupData}" var="rprt" varStatus="rpritr">
                        ...
                        <tr class="${rowClass}">
                            ...
                            <td width="10%">
                             <a title="Edit" target="_self" style="text-decoration:none" href="${pageContext.request.contextPath}/authenticate.htm?empId=${employee_no}&modId=531&customerGroupId=${rprt.groupId}"><img src="${pageContext.request.contextPath}/css/images/document-blue.png" style="padding-left: 18px;"></a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
