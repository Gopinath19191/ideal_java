<%-- 
    Document   : rmApprove
    Created on : 5 Dec, 2017, 9:52:40 AM
    Author     : 16221
--%>
    ...
    <body>
        ...
        <div class="container_inner"> 
            ...
            <div class="listLink">
                ...
                <a style="text-decoration:none;color: #4C83B3;" target="_self" href="procurementRMList.htm?status=${procurementDetails.get(0).status}">Purchase Approver List</a>
            </div>
        </div>
        <form action="approveRMProcurement.htm" name="saveDetails" id="approveDetails" method="post" enctype="multipart/form-data" autocomplete="off">
            <div id="content">
                ...
                <c:if test="${procurementDetails.get(0).status=='m'}">
                ...
                <div class="buttonClass">
                    <input type="hidden" id="approveStatus" value="a"/>
                    <input type="hidden" id="rejectStatus" value="r"/>
                    <input type="button" name="buttonCancel" id="buttonCancel" value="Back" class="cancelbutton" onclick="javascript: location.href='procurementRMList.htm?status=${procurementDetails.get(0).status}'"/>
                    <c:if test="${procurementDetails.get(0).status=='m'}">
