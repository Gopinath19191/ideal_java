<%-- 
    Document   : invoice_Annexure_Report
    Created on : 27 Jul, 2022, 5:26:32 PM
    Author     : 18128
--%>
...
<html>
    <head>
        <title> Invoice Annexure Report </title>
    ...
    <script type="text/javascript">
        ...
        function downloadExcel(){
            ...
            if(from_date ==""){           
                ...
                $.ajax({
                    type: 'POST',
                    url: 'getInvoiceAnnexureReportXL.htm?customer_id='+customer_id+'&project_id='+project_id+'&from_date='+from_date+'&to_date='+to_date,
                    success: function(response) {                        
                        $("#InvoiceAnnexureReport").submit();
                    }
                });
            }
        }
        ...
        $(document).ready(function(){
            ...
            $('#customerList').change(function () {
                ...
                $.ajax({
                    url: 'getInvoiceAnnexureProjectList.htm',
                    type: "POST",
                    async: false,
            ...
            $("#fromDate").datepicker({          
                ...
                onSelect: function () {
                    ...
                    endDate = new Date(endDate.setDate(endDate.getDate() + 60));
                    if(endDate>=today){
        ...
        <div id="container">          
            <div class="container_inner">
                <div class="page_heading">
                     Invoice Annexure Report
                </div>

            </div>            
            <div class="tabletools">
                <form action="getInvoiceAnnexureReportDownload.htm" id="InvoiceAnnexureReport" name="InvoiceAnnexureReport" method="POST">               
