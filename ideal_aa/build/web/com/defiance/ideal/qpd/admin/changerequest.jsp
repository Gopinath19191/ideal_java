    ...
    <body onkeypress="return noenter()">
          <div class="tabletools submenuwrap">
               ...
               <div class="contentwrap">
                <div class="contentBand">Change Appraiser</div>
                <div class="contentarea">
                    <form action="change.do" method="POST" name="employeeFilterForm" id="employeeFilterForm" >
                                ...
                                <select name="appraisalPeriodFilter" id="appraisalPeriod" class="required">
                                    <option value="">-- Select period --</option>
                                        <c:forEach begin="1" end="4" var="qValue">
                                              <c:choose>
                                                <c:when test="${appraisalPeriod == qValue}">
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="appraiserId" id="appraiserName"  >
                        ...
                        <tr>
                            <td style="text-align: center" colspan="8" >
                                <%--<font color="green">QPD Data Changed Successfully</font>--%>
                       ...
                       <tr class="${rowClass}">
                        ...
                        <tr>
                            <td colspan="10" align="center" style="text-align: center">
                                ...
                                <input type="submit" class="buttons changebutton" value="Change Appraisee Data" name="submitAppraisal" onclick="disableButtons()"/>
